...
| `test-ping-e2e`       | E2E (ping app)                      | Conditional                                             | `needs: [build, e2e-affected]` and `affected_ping == 'true'`       | starts Canton+services and runs Playwright for `@canton-network/example-ping`                                            |
