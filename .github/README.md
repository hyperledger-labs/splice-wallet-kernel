...
| `e2e-affected`        | Gate/check job                      | Always                                                  | None                                                                | computes suite-specific outputs: `run_tests_ping`, `run_tests_portfolio`, `run_tests_wallet_sdk` plus matched project lists |
