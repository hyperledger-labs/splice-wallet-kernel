...
We have removed the configure() and connect() pattern in favor of passing in a static configuration or a ledger provider.
.. code-block:: javascript
    ...
    //These namespaces get intiialized lazily once a config is passed in
...
Namespace changes:
We have removed the controllers and replcaed them with namespaces.
