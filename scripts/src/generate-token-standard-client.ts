...
// Directories
const OUTPUT_DIR = `${getRepoRoot()}/core/token-standard/src/generated-clients`
const SPECS_DIR = `${getRepoRoot()}/api-specs/token-standard`
...
console.log(
    'Generated fresh TypeScript clients for all token standard API specs'
)
