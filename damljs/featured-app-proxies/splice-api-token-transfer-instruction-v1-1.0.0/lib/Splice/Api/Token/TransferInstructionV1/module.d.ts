...
export declare type TransferFactory =
    damlTypes.Interface<'#splice-api-token-transfer-instruction-v1:Splice.Api.Token.TransferInstructionV1:TransferFactory'> &
        TransferFactoryView
...
export declare type TransferInstruction =
    damlTypes.Interface<'#splice-api-token-transfer-instruction-v1:Splice.Api.Token.TransferInstructionV1:TransferInstruction'> &
