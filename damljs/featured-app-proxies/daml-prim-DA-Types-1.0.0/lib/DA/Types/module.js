        ...
        encode: function (__typed__) {
            switch (__typed__.tag) {
                ...
                case 'Right':
                    return {
                        tag: __typed__.tag,
                        value: b.encode(__typed__.value),
                    }
                default:
                    throw (
                        'unrecognized type tag: ' +
                        __typed__.tag +
                        ' while serializing a value of type Either'
                    )
            }
        },
    }
...
exports.Tuple2 = function (t1, t2) {
    return {
        decoder: damlTypes.lazyMemo(function () {
            return jtv.object({ _1: t1.decoder, _2: t2.decoder })
        }),
        encode: function (__typed__) {
            return {
