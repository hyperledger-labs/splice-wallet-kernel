...
class ScalaPbOptions$Type extends MessageType<ScalaPbOptions> {
            ...
            switch (fieldNo) {
                ...
                case /* repeated scalapb.ScalaPbOptions.AuxMessageOptions aux_message_options */ 18:
                    message.auxMessageOptions.push(
                        ScalaPbOptions_AuxMessageOptions.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options
                        )
                ...
                case /* repeated scalapb.ScalaPbOptions.AuxFieldOptions aux_field_options */ 19:
                    message.auxFieldOptions.push(
                        ScalaPbOptions_AuxFieldOptions.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options
                        )
                ...
                case /* repeated scalapb.ScalaPbOptions.AuxEnumOptions aux_enum_options */ 20:
                    message.auxEnumOptions.push(
                        ScalaPbOptions_AuxEnumOptions.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options
                        )
                ...
                case /* repeated scalapb.ScalaPbOptions.AuxEnumValueOptions aux_enum_value_options */ 22:
                    message.auxEnumValueOptions.push(
                        ScalaPbOptions_AuxEnumValueOptions.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options
                        )
                ...
                case /* repeated scalapb.FieldTransformation field_transformations */ 25:
                    message.fieldTransformations.push(
                        FieldTransformation.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options
                        )
    ...
    internalBinaryWrite(
        ...
        for (let i = 0; i < message.auxMessageOptions.length; i++)
            ScalaPbOptions_AuxMessageOptions.internalBinaryWrite(
                message.auxMessageOptions[i],
        ...
        for (let i = 0; i < message.auxFieldOptions.length; i++)
            ScalaPbOptions_AuxFieldOptions.internalBinaryWrite(
                message.auxFieldOptions[i],
        ...
        for (let i = 0; i < message.auxEnumOptions.length; i++)
            ScalaPbOptions_AuxEnumOptions.internalBinaryWrite(
                message.auxEnumOptions[i],
        ...
        for (let i = 0; i < message.auxEnumValueOptions.length; i++)
            ScalaPbOptions_AuxEnumValueOptions.internalBinaryWrite(
                message.auxEnumValueOptions[i],
        ...
        for (let i = 0; i < message.fieldTransformations.length; i++)
            FieldTransformation.internalBinaryWrite(
                message.fieldTransformations[i],
...
class ScalaPbOptions_AuxMessageOptions$Type extends MessageType<ScalaPbOptions_AuxMessageOptions> {
    ...
    create(
        value?: PartialMessage<ScalaPbOptions_AuxMessageOptions>
    ): ScalaPbOptions_AuxMessageOptions {
        const message = globalThis.Object.create(this.messagePrototype!)
        if (value !== undefined)
            reflectionMergePartial<ScalaPbOptions_AuxMessageOptions>(
                this,
                message,
                value
            )
    ...
    internalBinaryRead(
        ...
        length: number,
        options: BinaryReadOptions,
        target?: ScalaPbOptions_AuxMessageOptions
    ): ScalaPbOptions_AuxMessageOptions {
        const message = target ?? this.create(),
            end = reader.pos + length
        while (reader.pos < end) {
 ...
 */
export const ScalaPbOptions_AuxMessageOptions =
    new ScalaPbOptions_AuxMessageOptions$Type()
// @generated message type with reflection information, may provide speed optimized methods
class ScalaPbOptions_AuxFieldOptions$Type extends MessageType<ScalaPbOptions_AuxFieldOptions> {
    ...
    create(
        value?: PartialMessage<ScalaPbOptions_AuxFieldOptions>
    ): ScalaPbOptions_AuxFieldOptions {
        const message = globalThis.Object.create(this.messagePrototype!)
        if (value !== undefined)
            reflectionMergePartial<ScalaPbOptions_AuxFieldOptions>(
                this,
                message,
                value
            )
    ...
    internalBinaryRead(
        ...
        length: number,
        options: BinaryReadOptions,
        target?: ScalaPbOptions_AuxFieldOptions
    ): ScalaPbOptions_AuxFieldOptions {
        const message = target ?? this.create(),
            end = reader.pos + length
        while (reader.pos < end) {
 ...
 */
export const ScalaPbOptions_AuxFieldOptions =
    new ScalaPbOptions_AuxFieldOptions$Type()
// @generated message type with reflection information, may provide speed optimized methods
class ScalaPbOptions_AuxEnumOptions$Type extends MessageType<ScalaPbOptions_AuxEnumOptions> {
    ...
    create(
        value?: PartialMessage<ScalaPbOptions_AuxEnumOptions>
    ): ScalaPbOptions_AuxEnumOptions {
        const message = globalThis.Object.create(this.messagePrototype!)
        if (value !== undefined)
            reflectionMergePartial<ScalaPbOptions_AuxEnumOptions>(
                this,
                message,
                value
            )
    ...
    internalBinaryRead(
        ...
        length: number,
        options: BinaryReadOptions,
        target?: ScalaPbOptions_AuxEnumOptions
    ): ScalaPbOptions_AuxEnumOptions {
        const message = target ?? this.create(),
            end = reader.pos + length
        while (reader.pos < end) {
 ...
 */
export const ScalaPbOptions_AuxEnumOptions =
    new ScalaPbOptions_AuxEnumOptions$Type()
// @generated message type with reflection information, may provide speed optimized methods
class ScalaPbOptions_AuxEnumValueOptions$Type extends MessageType<ScalaPbOptions_AuxEnumValueOptions> {
    ...
    create(
        value?: PartialMessage<ScalaPbOptions_AuxEnumValueOptions>
    ): ScalaPbOptions_AuxEnumValueOptions {
        const message = globalThis.Object.create(this.messagePrototype!)
        if (value !== undefined)
            reflectionMergePartial<ScalaPbOptions_AuxEnumValueOptions>(
                this,
                message,
                value
            )
    ...
    internalBinaryRead(
        ...
        length: number,
        options: BinaryReadOptions,
        target?: ScalaPbOptions_AuxEnumValueOptions
    ): ScalaPbOptions_AuxEnumValueOptions {
        const message = target ?? this.create(),
            end = reader.pos + length
        while (reader.pos < end) {
 ...
 */
export const ScalaPbOptions_AuxEnumValueOptions =
    new ScalaPbOptions_AuxEnumValueOptions$Type()
// @generated message type with reflection information, may provide speed optimized methods
...
class FieldOptions$Type extends MessageType<FieldOptions> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* optional scalapb.Collection collection */ 8:
                    message.collection = Collection.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.collection
    ...
    internalBinaryWrite(
        ...
        if (message.collection)
            Collection.internalBinaryWrite(
                message.collection,
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* optional google.protobuf.FieldDescriptorProto when */ 1:
                    message.when = FieldDescriptorProto.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.when
                ...
                case /* optional google.protobuf.FieldOptions set */ 3:
                    message.set = FieldOptions$.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.set
...
class PreprocessorOutput$Type extends MessageType<PreprocessorOutput> {
    ...
    private binaryReadMap1(
        map: PreprocessorOutput['optionsByFile'],
        reader: IBinaryReader,
        options: BinaryReadOptions
    ): void {
        let len = reader.uint32(),
            end = reader.pos + len,
            key: keyof PreprocessorOutput['optionsByFile'] | undefined,
            val: PreprocessorOutput['optionsByFile'][any] | undefined
        while (reader.pos < end) {
            const [fieldNo, wireType] = reader.tag()
            switch (fieldNo) {
                case 1:
                    ...
                    break
                case 2:
                    val = ScalaPbOptions.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options
                    )
                ...
                default:
                    throw new globalThis.Error(
                        'unknown map entry field for scalapb.PreprocessorOutput.options_by_file'
                    )
            }
        }
    ...
    internalBinaryWrite(
        ...
        for (const k of globalThis.Object.keys(message.optionsByFile)) {
            writer
                ...
                .string(k)
            writer.tag(2, WireType.LengthDelimited).fork()
            ScalaPbOptions.internalBinaryWrite(
                message.optionsByFile[k],
                writer,
                options
            )
            writer.join().join()
