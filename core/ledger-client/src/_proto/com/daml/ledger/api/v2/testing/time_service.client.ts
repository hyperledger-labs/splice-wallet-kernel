...
export interface ITimeServiceClient {
    ...
    getTime(
        ...
        options?: RpcOptions
    ): UnaryCall<GetTimeRequest, GetTimeResponse>
    /**
     ...
     */
    setTime(
        input: SetTimeRequest,
        options?: RpcOptions
    ): UnaryCall<SetTimeRequest, Empty>
}
/**
 * Optional service, exposed for testing static time scenarios.
 *
...
export class TimeServiceClient implements ITimeServiceClient, ServiceInfo {
    ...
    getTime(
        ...
        return stackIntercept<GetTimeRequest, GetTimeResponse>(
            'unary',
            this._transport,
            method,
            opt,
    ...
    setTime(
        ...
        const method = this.methods[1],
            opt = this._transport.mergeOptions(options)
        return stackIntercept<SetTimeRequest, Empty>(
            'unary',
            this._transport,
            method,
            opt,
