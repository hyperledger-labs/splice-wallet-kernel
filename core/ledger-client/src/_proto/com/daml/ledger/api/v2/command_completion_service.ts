...
class CompletionStreamRequest$Type extends MessageType<CompletionStreamRequest> {
    ...
    create(
        value?: PartialMessage<CompletionStreamRequest>
        ...
        if (value !== undefined)
            reflectionMergePartial<CompletionStreamRequest>(
                this,
                message,
                value
            )
    ...
    internalBinaryRead(
        ...
        target?: CompletionStreamRequest
    ): CompletionStreamRequest {
...
class CompletionStreamResponse$Type extends MessageType<CompletionStreamResponse> {
    ...
    create(
        value?: PartialMessage<CompletionStreamResponse>
    ): CompletionStreamResponse {
        const message = globalThis.Object.create(this.messagePrototype!)
        message.completionResponse = { oneofKind: undefined }
        if (value !== undefined)
            reflectionMergePartial<CompletionStreamResponse>(
                this,
                message,
                value
            )
    ...
    internalBinaryRead(
        ...
        length: number,
        options: BinaryReadOptions,
        target?: CompletionStreamResponse
    ): CompletionStreamResponse {
        let message = target ?? this.create(),
            end = reader.pos + length
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* com.daml.ledger.api.v2.Completion completion */ 1:
                    message.completionResponse = {
                        oneofKind: 'completion',
                        completion: Completion.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options,
                            (message.completionResponse as any).completion
                        ),
                    }
                    break
                case /* com.daml.ledger.api.v2.OffsetCheckpoint offset_checkpoint */ 2:
                    message.completionResponse = {
                        ...
                        offsetCheckpoint: OffsetCheckpoint.internalBinaryRead(
                            ...
                            reader.uint32(),
                            options,
                            (message.completionResponse as any).offsetCheckpoint
                        ),
                    }
                    break
                default:
    ...
    internalBinaryWrite(
        ...
        if (message.completionResponse.oneofKind === 'offsetCheckpoint')
            OffsetCheckpoint.internalBinaryWrite(
                message.completionResponse.offsetCheckpoint,
 ...
 */
export const CommandCompletionService = new ServiceType(
