        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* google.protobuf.Empty unit */ 1:
                    message.sum = {
                        oneofKind: 'unit',
                        unit: Empty.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options,
                            (message.sum as any).unit
                        ),
                    }
                    break
                case /* bool bool */ 2:
                ...
                case /* com.daml.ledger.api.v2.Optional optional */ 10:
                    message.sum = {
                        oneofKind: 'optional',
                        optional: Optional.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options,
                            (message.sum as any).optional
                        ),
                    }
                    break
                case /* com.daml.ledger.api.v2.List list */ 11:
                    message.sum = {
                        oneofKind: 'list',
                        list: List.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options,
                            (message.sum as any).list
                        ),
                    }
                    break
                case /* com.daml.ledger.api.v2.TextMap text_map */ 12:
                    message.sum = {
                        oneofKind: 'textMap',
                        textMap: TextMap.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options,
                            (message.sum as any).textMap
                        ),
                    }
                    break
                case /* com.daml.ledger.api.v2.GenMap gen_map */ 13:
                    message.sum = {
                        oneofKind: 'genMap',
                        genMap: GenMap.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options,
                            (message.sum as any).genMap
                        ),
                    }
                    break
                case /* com.daml.ledger.api.v2.Record record */ 14:
                    message.sum = {
                        oneofKind: 'record',
                        record: Record.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options,
                            (message.sum as any).record
                        ),
                    }
                    break
                case /* com.daml.ledger.api.v2.Variant variant */ 15:
                    message.sum = {
                        oneofKind: 'variant',
                        variant: Variant.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options,
                            (message.sum as any).variant
                        ),
                    }
                    break
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* com.daml.ledger.api.v2.Identifier record_id */ 1:
                    message.recordId = Identifier.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.recordId
                ...
                case /* repeated com.daml.ledger.api.v2.RecordField fields */ 2:
                    message.fields.push(
                        RecordField.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options
                        )
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* com.daml.ledger.api.v2.Identifier variant_id */ 1:
                    message.variantId = Identifier.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.variantId
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* com.daml.ledger.api.v2.Identifier enum_id */ 1:
                    message.enumId = Identifier.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.enumId
            ...
            switch (fieldNo) {
                case /* repeated com.daml.ledger.api.v2.TextMap.Entry entries */ 1:
                    message.entries.push(
                        TextMap_Entry.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options
                        )
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated com.daml.ledger.api.v2.GenMap.Entry entries */ 1:
                    message.entries.push(
                        GenMap_Entry.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options
                        )
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* com.daml.ledger.api.v2.Value key */ 1:
                    message.key = Value.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.key
