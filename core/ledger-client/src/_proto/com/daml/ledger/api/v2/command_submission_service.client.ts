...
export interface ICommandSubmissionServiceClient {
    ...
    submit(
        input: SubmitRequest,
        options?: RpcOptions
    ): UnaryCall<SubmitRequest, SubmitResponse>
    /**
     ...
     */
    submitReassignment(
        input: SubmitReassignmentRequest,
        options?: RpcOptions
    ): UnaryCall<SubmitReassignmentRequest, SubmitReassignmentResponse>
}
/**
 * Allows clients to attempt advancing the ledger's state by submitting commands.
 * The final states of their submissions are disclosed by the Command Completion Service.
...
export class CommandSubmissionServiceClient
    implements ICommandSubmissionServiceClient, ServiceInfo
{
    ...
    submit(
        ...
        return stackIntercept<SubmitRequest, SubmitResponse>(
            'unary',
            this._transport,
            method,
            opt,
