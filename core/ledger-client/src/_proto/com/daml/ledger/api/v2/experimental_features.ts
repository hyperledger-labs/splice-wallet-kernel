...
class ExperimentalFeatures$Type extends MessageType<ExperimentalFeatures> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* com.daml.ledger.api.v2.ExperimentalStaticTime static_time */ 1:
                    message.staticTime =
                        ExperimentalStaticTime.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options,
                            message.staticTime
                ...
                case /* com.daml.ledger.api.v2.ExperimentalCommandInspectionService command_inspection_service */ 2:
                    message.commandInspectionService =
                        ExperimentalCommandInspectionService.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options,
                            message.commandInspectionService
    ...
    internalBinaryWrite(
        ...
        if (message.staticTime)
            ExperimentalStaticTime.internalBinaryWrite(
                message.staticTime,
        ...
        if (message.commandInspectionService)
            ExperimentalCommandInspectionService.internalBinaryWrite(
                message.commandInspectionService,
...
class ExperimentalStaticTime$Type extends MessageType<ExperimentalStaticTime> {
    ...
    create(
        value?: PartialMessage<ExperimentalStaticTime>
...
class ExperimentalCommandInspectionService$Type extends MessageType<ExperimentalCommandInspectionService> {
    ...
    create(
        value?: PartialMessage<ExperimentalCommandInspectionService>
    ): ExperimentalCommandInspectionService {
        const message = globalThis.Object.create(this.messagePrototype!)
        message.supported = false
        if (value !== undefined)
            reflectionMergePartial<ExperimentalCommandInspectionService>(
                this,
                message,
                value
            )
    ...
    internalBinaryRead(
        ...
        length: number,
        options: BinaryReadOptions,
        target?: ExperimentalCommandInspectionService
    ): ExperimentalCommandInspectionService {
        let message = target ?? this.create(),
            end = reader.pos + length
        while (reader.pos < end) {
 ...
 */
export const ExperimentalCommandInspectionService =
    new ExperimentalCommandInspectionService$Type()
// @generated message type with reflection information, may provide speed optimized methods
class ExperimentalPartyTopologyEvents$Type extends MessageType<ExperimentalPartyTopologyEvents> {
    ...
    create(
        value?: PartialMessage<ExperimentalPartyTopologyEvents>
    ): ExperimentalPartyTopologyEvents {
        const message = globalThis.Object.create(this.messagePrototype!)
        message.supported = false
        if (value !== undefined)
            reflectionMergePartial<ExperimentalPartyTopologyEvents>(
                this,
                message,
                value
            )
    ...
    internalBinaryRead(
        ...
        length: number,
        options: BinaryReadOptions,
        target?: ExperimentalPartyTopologyEvents
    ): ExperimentalPartyTopologyEvents {
        let message = target ?? this.create(),
            end = reader.pos + length
        while (reader.pos < end) {
 ...
 */
export const ExperimentalPartyTopologyEvents =
    new ExperimentalPartyTopologyEvents$Type()
