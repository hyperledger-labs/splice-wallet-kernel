    ...
    private binaryReadMap3(
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                default:
                    throw new globalThis.Error(
                        'unknown map entry field for google.rpc.ErrorInfo.metadata'
                    )
            }
        }
        map[key ?? ''] = val ?? ''
            ...
            switch (fieldNo) {
                case /* repeated google.rpc.QuotaFailure.Violation violations */ 1:
                    message.violations.push(
                        QuotaFailure_Violation.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options
                        )
...
class QuotaFailure_Violation$Type extends MessageType<QuotaFailure_Violation> {
    ...
    create(
        value?: PartialMessage<QuotaFailure_Violation>
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated google.rpc.PreconditionFailure.Violation violations */ 1:
                    message.violations.push(
                        PreconditionFailure_Violation.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options
                        )
...
class PreconditionFailure_Violation$Type extends MessageType<PreconditionFailure_Violation> {
    ...
    create(
        value?: PartialMessage<PreconditionFailure_Violation>
        ...
        message.description = ''
        if (value !== undefined)
            reflectionMergePartial<PreconditionFailure_Violation>(
                this,
                message,
                value
            )
            ...
            switch (fieldNo) {
                case /* repeated google.rpc.BadRequest.FieldViolation field_violations */ 1:
                    message.fieldViolations.push(
                        BadRequest_FieldViolation.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options
                        )
...
class BadRequest_FieldViolation$Type extends MessageType<BadRequest_FieldViolation> {
    ...
    create(
        value?: PartialMessage<BadRequest_FieldViolation>
    ): BadRequest_FieldViolation {
        const message = globalThis.Object.create(this.messagePrototype!)
        message.field = ''
        message.description = ''
        if (value !== undefined)
            reflectionMergePartial<BadRequest_FieldViolation>(
                this,
                message,
                value
            )
