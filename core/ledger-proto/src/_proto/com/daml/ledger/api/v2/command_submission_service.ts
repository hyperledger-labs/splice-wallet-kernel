...
class SubmitReassignmentRequest$Type extends MessageType<SubmitReassignmentRequest> {
    ...
    create(
        value?: PartialMessage<SubmitReassignmentRequest>
    ): SubmitReassignmentRequest {
        const message = globalThis.Object.create(this.messagePrototype!)
        if (value !== undefined)
            reflectionMergePartial<SubmitReassignmentRequest>(
                this,
                message,
                value
            )
    ...
    internalBinaryRead(
        ...
        length: number,
        options: BinaryReadOptions,
        target?: SubmitReassignmentRequest
    ): SubmitReassignmentRequest {
        let message = target ?? this.create(),
            end = reader.pos + length
        while (reader.pos < end) {
...
class SubmitReassignmentResponse$Type extends MessageType<SubmitReassignmentResponse> {
    ...
    create(
        value?: PartialMessage<SubmitReassignmentResponse>
    ): SubmitReassignmentResponse {
        const message = globalThis.Object.create(this.messagePrototype!)
        if (value !== undefined)
            reflectionMergePartial<SubmitReassignmentResponse>(
                this,
                message,
                value
            )
    ...
    internalBinaryRead(
        ...
        length: number,
        options: BinaryReadOptions,
        target?: SubmitReassignmentResponse
    ): SubmitReassignmentResponse {
        let message = target ?? this.create(),
            end = reader.pos + length
        while (reader.pos < end) {
 ...
 */
export const CommandSubmissionService = new ServiceType(
