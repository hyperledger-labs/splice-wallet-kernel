...
export interface IPartyManagementServiceClient {
     ...
     */
    getParticipantId(
        input: GetParticipantIdRequest,
        options?: RpcOptions
    ): UnaryCall<GetParticipantIdRequest, GetParticipantIdResponse>
    /**
     ...
     */
    getParties(
        input: GetPartiesRequest,
        options?: RpcOptions
    ): UnaryCall<GetPartiesRequest, GetPartiesResponse>
    /**
     ...
     */
    listKnownParties(
        input: ListKnownPartiesRequest,
        options?: RpcOptions
    ): UnaryCall<ListKnownPartiesRequest, ListKnownPartiesResponse>
    /**
    ...
    updatePartyIdentityProviderId(
        input: UpdatePartyIdentityProviderIdRequest,
        options?: RpcOptions
    ): UnaryCall<
...
export class PartyManagementServiceClient
    implements IPartyManagementServiceClient, ServiceInfo
{
    ...
    getParties(
        ...
        const method = this.methods[1],
            opt = this._transport.mergeOptions(options)
        return stackIntercept<GetPartiesRequest, GetPartiesResponse>(
            'unary',
            this._transport,
            method,
            opt,
    ...
    allocateParty(
        ...
        const method = this.methods[3],
            opt = this._transport.mergeOptions(options)
        return stackIntercept<AllocatePartyRequest, AllocatePartyResponse>(
            'unary',
            this._transport,
            method,
            opt,
