...
class PrepareSubmissionRequest$Type extends MessageType<PrepareSubmissionRequest> {
    ...
    create(
        value?: PartialMessage<PrepareSubmissionRequest>
        ...
        if (value !== undefined)
            reflectionMergePartial<PrepareSubmissionRequest>(
                this,
                message,
                value
            )
    ...
    internalBinaryRead(
        ...
        target?: PrepareSubmissionRequest
    ): PrepareSubmissionRequest {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* com.daml.ledger.api.v2.interactive.MinLedgerTime min_ledger_time */ 4:
                    message.minLedgerTime = MinLedgerTime.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
    ...
    internalBinaryWrite(
        ...
        if (message.minLedgerTime)
            MinLedgerTime.internalBinaryWrite(
                message.minLedgerTime,
...
class PrepareSubmissionResponse$Type extends MessageType<PrepareSubmissionResponse> {
    ...
    create(
        value?: PartialMessage<PrepareSubmissionResponse>
    ): PrepareSubmissionResponse {
        const message = globalThis.Object.create(this.messagePrototype!)
        message.preparedTransactionHash = new Uint8Array(0)
        message.hashingSchemeVersion = 0
        if (value !== undefined)
            reflectionMergePartial<PrepareSubmissionResponse>(
                this,
                message,
                value
            )
    ...
    internalBinaryRead(
        ...
        length: number,
        options: BinaryReadOptions,
        target?: PrepareSubmissionResponse
    ): PrepareSubmissionResponse {
        let message = target ?? this.create(),
            end = reader.pos + length
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* com.daml.ledger.api.v2.interactive.PreparedTransaction prepared_transaction */ 1:
                    message.preparedTransaction =
                        PreparedTransaction.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options,
                            message.preparedTransaction
    ...
    internalBinaryWrite(
        ...
        if (message.preparedTransaction)
            PreparedTransaction.internalBinaryWrite(
                message.preparedTransaction,
...
class SinglePartySignatures$Type extends MessageType<SinglePartySignatures> {
    ...
    create(
        value?: PartialMessage<SinglePartySignatures>
...
class PartySignatures$Type extends MessageType<PartySignatures> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated com.daml.ledger.api.v2.interactive.SinglePartySignatures signatures */ 1:
                    message.signatures.push(
                        SinglePartySignatures.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options
                        )
    ...
    internalBinaryWrite(
        ...
        for (let i = 0; i < message.signatures.length; i++)
            SinglePartySignatures.internalBinaryWrite(
                message.signatures[i],
                writer.tag(1, WireType.LengthDelimited).fork(),
                options
            ).join()
...
class ExecuteSubmissionRequest$Type extends MessageType<ExecuteSubmissionRequest> {
    ...
    create(
        value?: PartialMessage<ExecuteSubmissionRequest>
        ...
        message.hashingSchemeVersion = 0
        if (value !== undefined)
            reflectionMergePartial<ExecuteSubmissionRequest>(
                this,
                message,
                value
            )
    ...
    internalBinaryRead(
        ...
        length: number,
        options: BinaryReadOptions,
        target?: ExecuteSubmissionRequest
    ): ExecuteSubmissionRequest {
        let message = target ?? this.create(),
            end = reader.pos + length
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* com.daml.ledger.api.v2.interactive.PartySignatures party_signatures */ 2:
                    message.partySignatures =
                        PartySignatures.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options,
                            message.partySignatures
    ...
    internalBinaryWrite(
        ...
        if (message.partySignatures)
            PartySignatures.internalBinaryWrite(
                message.partySignatures,
                writer.tag(2, WireType.LengthDelimited).fork(),
                options
            ).join()
...
class ExecuteSubmissionResponse$Type extends MessageType<ExecuteSubmissionResponse> {
    ...
    create(
        value?: PartialMessage<ExecuteSubmissionResponse>
    ): ExecuteSubmissionResponse {
        const message = globalThis.Object.create(this.messagePrototype!)
        if (value !== undefined)
            reflectionMergePartial<ExecuteSubmissionResponse>(
                this,
                message,
                value
            )
    ...
    internalBinaryRead(
        ...
        length: number,
        options: BinaryReadOptions,
        target?: ExecuteSubmissionResponse
    ): ExecuteSubmissionResponse {
        let message = target ?? this.create(),
            end = reader.pos + length
        while (reader.pos < end) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* google.protobuf.Timestamp min_ledger_time_abs */ 1:
                    message.time = {
                        oneofKind: 'minLedgerTimeAbs',
                        minLedgerTimeAbs: Timestamp.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options,
                            (message.time as any).minLedgerTimeAbs
                        ),
                    }
                    break
                case /* google.protobuf.Duration min_ledger_time_rel */ 2:
                    message.time = {
                        oneofKind: 'minLedgerTimeRel',
                        minLedgerTimeRel: Duration.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options,
                            (message.time as any).minLedgerTimeRel
                        ),
                    }
                    break
                default:
            ...
            switch (fieldNo) {
                case /* com.daml.ledger.api.v2.interactive.Metadata.SubmitterInfo submitter_info */ 2:
                    message.submitterInfo =
                        Metadata_SubmitterInfo.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options,
                            message.submitterInfo
                ...
                case /* repeated com.daml.ledger.api.v2.interactive.Metadata.InputContract input_contracts */ 7:
                    message.inputContracts.push(
                        Metadata_InputContract.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options
                        )
                ...
                case /* repeated com.daml.ledger.api.v2.interactive.Metadata.GlobalKeyMappingEntry global_key_mapping */ 8:
                    message.globalKeyMapping.push(
                        Metadata_GlobalKeyMappingEntry.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options
                        )
...
class Metadata_SubmitterInfo$Type extends MessageType<Metadata_SubmitterInfo> {
    ...
    create(
        value?: PartialMessage<Metadata_SubmitterInfo>
    ...
    internalBinaryWrite(
        message: Metadata_SubmitterInfo,
        writer: IBinaryWriter,
        options: BinaryWriteOptions
    ): IBinaryWriter {
...
class Metadata_GlobalKeyMappingEntry$Type extends MessageType<Metadata_GlobalKeyMappingEntry> {
    ...
    create(
        value?: PartialMessage<Metadata_GlobalKeyMappingEntry>
    ): Metadata_GlobalKeyMappingEntry {
        const message = globalThis.Object.create(this.messagePrototype!)
        if (value !== undefined)
            reflectionMergePartial<Metadata_GlobalKeyMappingEntry>(
                this,
                message,
                value
            )
    ...
    internalBinaryRead(
        ...
        length: number,
        options: BinaryReadOptions,
        target?: Metadata_GlobalKeyMappingEntry
    ): Metadata_GlobalKeyMappingEntry {
        let message = target ?? this.create(),
            end = reader.pos + length
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* com.daml.ledger.api.v2.interactive.GlobalKey key */ 1:
                    message.key = GlobalKey.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.key
    ...
    internalBinaryWrite(
        message: Metadata_GlobalKeyMappingEntry,
        writer: IBinaryWriter,
        options: BinaryWriteOptions
    ): IBinaryWriter {
        /* com.daml.ledger.api.v2.interactive.GlobalKey key = 1; */
        if (message.key)
            GlobalKey.internalBinaryWrite(
                message.key,
                writer.tag(1, WireType.LengthDelimited).fork(),
                options
            ).join()
 ...
 */
export const Metadata_GlobalKeyMappingEntry =
    new Metadata_GlobalKeyMappingEntry$Type()
// @generated message type with reflection information, may provide speed optimized methods
class Metadata_InputContract$Type extends MessageType<Metadata_InputContract> {
    ...
    create(
        value?: PartialMessage<Metadata_InputContract>
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* com.daml.ledger.api.v2.interactive.transaction.v1.Create v1 */ 1:
                    message.contract = {
                        oneofKind: 'v1',
                        v1: Create.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options,
                            (message.contract as any).v1
                        ),
                    }
                    break
    ...
    internalBinaryWrite(
        message: Metadata_InputContract,
        writer: IBinaryWriter,
        options: BinaryWriteOptions
    ): IBinaryWriter {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated com.daml.ledger.api.v2.interactive.DamlTransaction.Node nodes */ 3:
                    message.nodes.push(
                        DamlTransaction_Node.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options
                        )
                ...
                case /* repeated com.daml.ledger.api.v2.interactive.DamlTransaction.NodeSeed node_seeds */ 4:
                    message.nodeSeeds.push(
                        DamlTransaction_NodeSeed.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options
                        )
...
class DamlTransaction_NodeSeed$Type extends MessageType<DamlTransaction_NodeSeed> {
    ...
    create(
        value?: PartialMessage<DamlTransaction_NodeSeed>
    ): DamlTransaction_NodeSeed {
        const message = globalThis.Object.create(this.messagePrototype!)
        message.nodeId = 0
        message.seed = new Uint8Array(0)
        if (value !== undefined)
            reflectionMergePartial<DamlTransaction_NodeSeed>(
                this,
                message,
                value
            )
    ...
    internalBinaryRead(
        ...
        length: number,
        options: BinaryReadOptions,
        target?: DamlTransaction_NodeSeed
    ): DamlTransaction_NodeSeed {
        let message = target ?? this.create(),
            end = reader.pos + length
        while (reader.pos < end) {
    ...
    internalBinaryWrite(
        message: DamlTransaction_NodeSeed,
        writer: IBinaryWriter,
        options: BinaryWriteOptions
    ): IBinaryWriter {
        /* int32 node_id = 1; */
            ...
            switch (fieldNo) {
                ...
                case /* com.daml.ledger.api.v2.interactive.transaction.v1.Node v1 */ 1000:
                    message.versionedNode = {
                        oneofKind: 'v1',
                        v1: Node.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options,
                            (message.versionedNode as any).v1
                        ),
                    }
                    break
                default:
...
class GetPreferredPackageVersionRequest$Type extends MessageType<GetPreferredPackageVersionRequest> {
    ...
    create(
        value?: PartialMessage<GetPreferredPackageVersionRequest>
        ...
        message.synchronizerId = ''
        if (value !== undefined)
            reflectionMergePartial<GetPreferredPackageVersionRequest>(
                this,
                message,
                value
            )
    ...
    internalBinaryRead(
        ...
        length: number,
        options: BinaryReadOptions,
        target?: GetPreferredPackageVersionRequest
    ): GetPreferredPackageVersionRequest {
        let message = target ?? this.create(),
            end = reader.pos + length
        while (reader.pos < end) {
 ...
 */
export const GetPreferredPackageVersionRequest =
    new GetPreferredPackageVersionRequest$Type()
// @generated message type with reflection information, may provide speed optimized methods
class GetPreferredPackageVersionResponse$Type extends MessageType<GetPreferredPackageVersionResponse> {
    ...
    create(
        value?: PartialMessage<GetPreferredPackageVersionResponse>
    ): GetPreferredPackageVersionResponse {
        const message = globalThis.Object.create(this.messagePrototype!)
        if (value !== undefined)
            reflectionMergePartial<GetPreferredPackageVersionResponse>(
                this,
                message,
                value
            )
    ...
    internalBinaryRead(
        ...
        length: number,
        options: BinaryReadOptions,
        target?: GetPreferredPackageVersionResponse
    ): GetPreferredPackageVersionResponse {
        let message = target ?? this.create(),
            end = reader.pos + length
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* com.daml.ledger.api.v2.interactive.PackagePreference package_preference */ 1:
                    message.packagePreference =
                        PackagePreference.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options,
                            message.packagePreference
    ...
    internalBinaryWrite(
        ...
        if (message.packagePreference)
            PackagePreference.internalBinaryWrite(
                message.packagePreference,
                writer.tag(1, WireType.LengthDelimited).fork(),
                options
            ).join()
 ...
 */
export const GetPreferredPackageVersionResponse =
    new GetPreferredPackageVersionResponse$Type()
// @generated message type with reflection information, may provide speed optimized methods
 ...
 */
export const InteractiveSubmissionService = new ServiceType(
