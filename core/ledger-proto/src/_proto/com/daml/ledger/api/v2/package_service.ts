...
class GetPackageStatusResponse$Type extends MessageType<GetPackageStatusResponse> {
    ...
    create(
        value?: PartialMessage<GetPackageStatusResponse>
    ): GetPackageStatusResponse {
        const message = globalThis.Object.create(this.messagePrototype!)
        message.packageStatus = 0
        if (value !== undefined)
            reflectionMergePartial<GetPackageStatusResponse>(
                this,
                message,
                value
            )
    ...
    internalBinaryRead(
        ...
        length: number,
        options: BinaryReadOptions,
        target?: GetPackageStatusResponse
    ): GetPackageStatusResponse {
        let message = target ?? this.create(),
            end = reader.pos + length
        while (reader.pos < end) {
...
class GetPackageStatusRequest$Type extends MessageType<GetPackageStatusRequest> {
    ...
    create(
        value?: PartialMessage<GetPackageStatusRequest>
    ): GetPackageStatusRequest {
        const message = globalThis.Object.create(this.messagePrototype!)
        message.packageId = ''
        if (value !== undefined)
            reflectionMergePartial<GetPackageStatusRequest>(
                this,
                message,
                value
            )
    ...
    internalBinaryRead(
        ...
        length: number,
        options: BinaryReadOptions,
        target?: GetPackageStatusRequest
    ): GetPackageStatusRequest {
        let message = target ?? this.create(),
            end = reader.pos + length
        while (reader.pos < end) {
