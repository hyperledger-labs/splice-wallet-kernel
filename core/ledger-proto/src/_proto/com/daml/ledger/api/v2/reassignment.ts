...
class Reassignment$Type extends MessageType<Reassignment> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated com.daml.ledger.api.v2.ReassignmentEvent events */ 5:
                    message.events.push(
                        ReassignmentEvent.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options
                        )
    ...
    internalBinaryWrite(
        ...
        for (let i = 0; i < message.events.length; i++)
            ReassignmentEvent.internalBinaryWrite(
                message.events[i],
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* com.daml.ledger.api.v2.UnassignedEvent unassigned */ 1:
                    message.event = {
                        oneofKind: 'unassigned',
                        unassigned: UnassignedEvent.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options,
                            (message.event as any).unassigned
                        ),
                    }
                    break
                case /* com.daml.ledger.api.v2.AssignedEvent assigned */ 2:
                    message.event = {
                        oneofKind: 'assigned',
                        assigned: AssignedEvent.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options,
                            (message.event as any).assigned
                        ),
                    }
                    break
                default:
