...
class GetEventsByContractIdRequest$Type extends MessageType<GetEventsByContractIdRequest> {
    ...
    create(
        value?: PartialMessage<GetEventsByContractIdRequest>
    ): GetEventsByContractIdRequest {
        const message = globalThis.Object.create(this.messagePrototype!)
        message.contractId = ''
        message.requestingParties = []
        if (value !== undefined)
            reflectionMergePartial<GetEventsByContractIdRequest>(
                this,
                message,
                value
            )
    ...
    internalBinaryRead(
        ...
        target?: GetEventsByContractIdRequest
    ): GetEventsByContractIdRequest {
 ...
 */
export const GetEventsByContractIdRequest =
    new GetEventsByContractIdRequest$Type()
// @generated message type with reflection information, may provide speed optimized methods
class GetEventsByContractIdResponse$Type extends MessageType<GetEventsByContractIdResponse> {
    ...
    create(
        value?: PartialMessage<GetEventsByContractIdResponse>
    ): GetEventsByContractIdResponse {
        const message = globalThis.Object.create(this.messagePrototype!)
        if (value !== undefined)
            reflectionMergePartial<GetEventsByContractIdResponse>(
                this,
                message,
                value
            )
    ...
    internalBinaryRead(
        ...
        length: number,
        options: BinaryReadOptions,
        target?: GetEventsByContractIdResponse
    ): GetEventsByContractIdResponse {
        let message = target ?? this.create(),
            end = reader.pos + length
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* com.daml.ledger.api.v2.Created created */ 1:
                    message.created = Created.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.created
                ...
                case /* com.daml.ledger.api.v2.Archived archived */ 2:
                    message.archived = Archived.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.archived
 ...
 */
export const GetEventsByContractIdResponse =
    new GetEventsByContractIdResponse$Type()
// @generated message type with reflection information, may provide speed optimized methods
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* com.daml.ledger.api.v2.ArchivedEvent archived_event */ 1:
                    message.archivedEvent = ArchivedEvent.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
 ...
 */
export const EventQueryService = new ServiceType(
