...
export interface ICommandServiceClient {
     ...
     */
    submitAndWait(
        input: SubmitAndWaitRequest,
        options?: RpcOptions
    ): UnaryCall<SubmitAndWaitRequest, SubmitAndWaitResponse>
    /**
    ...
    submitAndWaitForTransaction(
        input: SubmitAndWaitForTransactionRequest,
        options?: RpcOptions
    ): UnaryCall<
    ...
    submitAndWaitForTransactionTree(
        input: SubmitAndWaitRequest,
        options?: RpcOptions
    ): UnaryCall<SubmitAndWaitRequest, SubmitAndWaitForTransactionTreeResponse>
    /**
    ...
    submitAndWaitForReassignment(
        input: SubmitAndWaitForReassignmentRequest,
        options?: RpcOptions
    ): UnaryCall<
    ...
    implements ICommandServiceClient, ServiceInfo
{
    ...
    submitAndWait(
        ...
        return stackIntercept<SubmitAndWaitRequest, SubmitAndWaitResponse>(
            'unary',
            this._transport,
            method,
            opt,
