        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* com.daml.ledger.api.v2.admin.ObjectMeta metadata */ 4:
                    message.metadata = ObjectMeta.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.metadata
...
class Right$Type extends MessageType<Right> {
            ...
            switch (fieldNo) {
                case /* com.daml.ledger.api.v2.admin.Right.ParticipantAdmin participant_admin */ 1:
                    message.kind = {
                        oneofKind: 'participantAdmin',
                        participantAdmin:
                            Right_ParticipantAdmin.internalBinaryRead(
                                reader,
                                reader.uint32(),
                                options,
                                (message.kind as any).participantAdmin
                            ),
                    }
                    break
                case /* com.daml.ledger.api.v2.admin.Right.CanActAs can_act_as */ 2:
                    message.kind = {
                        oneofKind: 'canActAs',
                        canActAs: Right_CanActAs.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options,
                            (message.kind as any).canActAs
                        ),
                    }
                    break
                case /* com.daml.ledger.api.v2.admin.Right.CanReadAs can_read_as */ 3:
                    message.kind = {
                        oneofKind: 'canReadAs',
                        canReadAs: Right_CanReadAs.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options,
                            (message.kind as any).canReadAs
                        ),
                    }
                    break
                case /* com.daml.ledger.api.v2.admin.Right.IdentityProviderAdmin identity_provider_admin */ 4:
                    message.kind = {
                        ...
                        identityProviderAdmin:
                            Right_IdentityProviderAdmin.internalBinaryRead(
                                reader,
                                reader.uint32(),
                                options,
                                (message.kind as any).identityProviderAdmin
                            ),
                    }
                    break
                case /* com.daml.ledger.api.v2.admin.Right.CanReadAsAnyParty can_read_as_any_party */ 5:
                    message.kind = {
                        oneofKind: 'canReadAsAnyParty',
                        canReadAsAnyParty:
                            Right_CanReadAsAnyParty.internalBinaryRead(
                                reader,
                                reader.uint32(),
                                options,
                                (message.kind as any).canReadAsAnyParty
                            ),
                    }
                    break
                default:
    ...
    internalBinaryWrite(
        ...
        if (message.kind.oneofKind === 'identityProviderAdmin')
            Right_IdentityProviderAdmin.internalBinaryWrite(
                message.kind.identityProviderAdmin,
                writer.tag(4, WireType.LengthDelimited).fork(),
                options
            ).join()
        /* com.daml.ledger.api.v2.admin.Right.CanReadAsAnyParty can_read_as_any_party = 5; */
        if (message.kind.oneofKind === 'canReadAsAnyParty')
            Right_CanReadAsAnyParty.internalBinaryWrite(
                message.kind.canReadAsAnyParty,
...
class Right_ParticipantAdmin$Type extends MessageType<Right_ParticipantAdmin> {
    ...
    create(
        value?: PartialMessage<Right_ParticipantAdmin>
    ...
    internalBinaryWrite(
        message: Right_ParticipantAdmin,
        writer: IBinaryWriter,
        options: BinaryWriteOptions
    ): IBinaryWriter {
        let u = options.writeUnknownFields
...
class Right_IdentityProviderAdmin$Type extends MessageType<Right_IdentityProviderAdmin> {
    ...
    create(
        value?: PartialMessage<Right_IdentityProviderAdmin>
    ): Right_IdentityProviderAdmin {
        const message = globalThis.Object.create(this.messagePrototype!)
        if (value !== undefined)
            reflectionMergePartial<Right_IdentityProviderAdmin>(
                this,
                message,
                value
            )
    ...
    internalBinaryRead(
        ...
        length: number,
        options: BinaryReadOptions,
        target?: Right_IdentityProviderAdmin
    ): Right_IdentityProviderAdmin {
        let message = target ?? this.create(),
            end = reader.pos + length
        while (reader.pos < end) {
    ...
    internalBinaryWrite(
        message: Right_IdentityProviderAdmin,
        writer: IBinaryWriter,
        options: BinaryWriteOptions
    ): IBinaryWriter {
        let u = options.writeUnknownFields
 ...
 */
export const Right_IdentityProviderAdmin =
    new Right_IdentityProviderAdmin$Type()
// @generated message type with reflection information, may provide speed optimized methods
class Right_CanReadAsAnyParty$Type extends MessageType<Right_CanReadAsAnyParty> {
    ...
    create(
        value?: PartialMessage<Right_CanReadAsAnyParty>
    ): Right_CanReadAsAnyParty {
        const message = globalThis.Object.create(this.messagePrototype!)
        if (value !== undefined)
            reflectionMergePartial<Right_CanReadAsAnyParty>(
                this,
                message,
                value
            )
    ...
    internalBinaryRead(
        ...
        length: number,
        options: BinaryReadOptions,
        target?: Right_CanReadAsAnyParty
    ): Right_CanReadAsAnyParty {
        let message = target ?? this.create(),
            end = reader.pos + length
        while (reader.pos < end) {
    ...
    internalBinaryWrite(
        message: Right_CanReadAsAnyParty,
        writer: IBinaryWriter,
        options: BinaryWriteOptions
    ): IBinaryWriter {
        let u = options.writeUnknownFields
...
class GrantUserRightsRequest$Type extends MessageType<GrantUserRightsRequest> {
    ...
    create(
        value?: PartialMessage<GrantUserRightsRequest>
...
class GrantUserRightsResponse$Type extends MessageType<GrantUserRightsResponse> {
    ...
    create(
        value?: PartialMessage<GrantUserRightsResponse>
    ): GrantUserRightsResponse {
        const message = globalThis.Object.create(this.messagePrototype!)
        message.newlyGrantedRights = []
        if (value !== undefined)
            reflectionMergePartial<GrantUserRightsResponse>(
                this,
                message,
                value
            )
    ...
    internalBinaryRead(
        ...
        length: number,
        options: BinaryReadOptions,
        target?: GrantUserRightsResponse
    ): GrantUserRightsResponse {
        let message = target ?? this.create(),
            end = reader.pos + length
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated com.daml.ledger.api.v2.admin.Right newly_granted_rights */ 1:
                    message.newlyGrantedRights.push(
                        Right.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options
...
class RevokeUserRightsRequest$Type extends MessageType<RevokeUserRightsRequest> {
    ...
    create(
        value?: PartialMessage<RevokeUserRightsRequest>
        ...
        message.identityProviderId = ''
        if (value !== undefined)
            reflectionMergePartial<RevokeUserRightsRequest>(
                this,
                message,
                value
            )
    ...
    internalBinaryRead(
        ...
        length: number,
        options: BinaryReadOptions,
        target?: RevokeUserRightsRequest
    ): RevokeUserRightsRequest {
        let message = target ?? this.create(),
            end = reader.pos + length
        while (reader.pos < end) {
...
class RevokeUserRightsResponse$Type extends MessageType<RevokeUserRightsResponse> {
    ...
    create(
        value?: PartialMessage<RevokeUserRightsResponse>
    ): RevokeUserRightsResponse {
        const message = globalThis.Object.create(this.messagePrototype!)
        message.newlyRevokedRights = []
        if (value !== undefined)
            reflectionMergePartial<RevokeUserRightsResponse>(
                this,
                message,
                value
            )
    ...
    internalBinaryRead(
        ...
        length: number,
        options: BinaryReadOptions,
        target?: RevokeUserRightsResponse
    ): RevokeUserRightsResponse {
        let message = target ?? this.create(),
            end = reader.pos + length
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated com.daml.ledger.api.v2.admin.Right newly_revoked_rights */ 1:
                    message.newlyRevokedRights.push(
                        Right.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options
...
class ListUserRightsRequest$Type extends MessageType<ListUserRightsRequest> {
    ...
    create(
        value?: PartialMessage<ListUserRightsRequest>
...
class ListUserRightsResponse$Type extends MessageType<ListUserRightsResponse> {
    ...
    create(
        value?: PartialMessage<ListUserRightsResponse>
...
class UpdateUserIdentityProviderIdRequest$Type extends MessageType<UpdateUserIdentityProviderIdRequest> {
    ...
    create(
        value?: PartialMessage<UpdateUserIdentityProviderIdRequest>
        ...
        if (value !== undefined)
            reflectionMergePartial<UpdateUserIdentityProviderIdRequest>(
                this,
                message,
                value
            )
    ...
    internalBinaryRead(
        ...
        length: number,
        options: BinaryReadOptions,
        target?: UpdateUserIdentityProviderIdRequest
    ): UpdateUserIdentityProviderIdRequest {
        let message = target ?? this.create(),
            end = reader.pos + length
        while (reader.pos < end) {
 ...
 */
export const UpdateUserIdentityProviderIdRequest =
    new UpdateUserIdentityProviderIdRequest$Type()
// @generated message type with reflection information, may provide speed optimized methods
class UpdateUserIdentityProviderIdResponse$Type extends MessageType<UpdateUserIdentityProviderIdResponse> {
    ...
    create(
        value?: PartialMessage<UpdateUserIdentityProviderIdResponse>
    ): UpdateUserIdentityProviderIdResponse {
        const message = globalThis.Object.create(this.messagePrototype!)
        if (value !== undefined)
            reflectionMergePartial<UpdateUserIdentityProviderIdResponse>(
                this,
                message,
                value
            )
    ...
    internalBinaryRead(
        ...
        length: number,
        options: BinaryReadOptions,
        target?: UpdateUserIdentityProviderIdResponse
    ): UpdateUserIdentityProviderIdResponse {
        let message = target ?? this.create(),
            end = reader.pos + length
        while (reader.pos < end) {
 ...
 */
export const UpdateUserIdentityProviderIdResponse =
    new UpdateUserIdentityProviderIdResponse$Type()
/**
 * @generated ServiceType for protobuf service com.daml.ledger.api.v2.admin.UserManagementService
 */
export const UserManagementService = new ServiceType(
