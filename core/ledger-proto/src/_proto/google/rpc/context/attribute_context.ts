...
class AttributeContext$Type extends MessageType<AttributeContext> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* google.rpc.context.AttributeContext.Peer origin */ 7:
                    message.origin = AttributeContext_Peer.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.origin
                ...
                case /* google.rpc.context.AttributeContext.Peer source */ 1:
                    message.source = AttributeContext_Peer.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.source
                ...
                case /* google.rpc.context.AttributeContext.Peer destination */ 2:
                    message.destination =
                        AttributeContext_Peer.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options,
                            message.destination
                ...
                case /* google.rpc.context.AttributeContext.Request request */ 3:
                    message.request =
                        AttributeContext_Request.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options,
                            message.request
                ...
                case /* google.rpc.context.AttributeContext.Response response */ 4:
                    message.response =
                        AttributeContext_Response.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options,
                            message.response
                ...
                case /* google.rpc.context.AttributeContext.Resource resource */ 5:
                    message.resource =
                        AttributeContext_Resource.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options,
                            message.resource
                ...
                case /* google.rpc.context.AttributeContext.Api api */ 6:
                    message.api = AttributeContext_Api.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.api
    ...
    internalBinaryWrite(
        ...
        if (message.source)
            AttributeContext_Peer.internalBinaryWrite(
                message.source,
        ...
        if (message.request)
            AttributeContext_Request.internalBinaryWrite(
                message.request,
        ...
        if (message.response)
            AttributeContext_Response.internalBinaryWrite(
                message.response,
        ...
        if (message.resource)
            AttributeContext_Resource.internalBinaryWrite(
                message.resource,
        ...
        if (message.api)
            AttributeContext_Api.internalBinaryWrite(
                message.api,
...
class AttributeContext_Peer$Type extends MessageType<AttributeContext_Peer> {
    ...
    create(
        value?: PartialMessage<AttributeContext_Peer>
    ...
    private binaryReadMap6(
        map: AttributeContext_Peer['labels'],
        reader: IBinaryReader,
        options: BinaryReadOptions
    ): void {
        let len = reader.uint32(),
            end = reader.pos + len,
            key: keyof AttributeContext_Peer['labels'] | undefined,
            val: AttributeContext_Peer['labels'][any] | undefined
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag()
            switch (fieldNo) {
                case 1:
                ...
                default:
                    throw new globalThis.Error(
                        'unknown map entry field for google.rpc.context.AttributeContext.Peer.labels'
                    )
            }
        }
        map[key ?? ''] = val ?? ''
...
class AttributeContext_Auth$Type extends MessageType<AttributeContext_Auth> {
    ...
    create(
        value?: PartialMessage<AttributeContext_Auth>
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.protobuf.Struct claims */ 4:
                    message.claims = Struct.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.claims
...
class AttributeContext_Request$Type extends MessageType<AttributeContext_Request> {
    ...
    create(
        value?: PartialMessage<AttributeContext_Request>
        ...
        message.reason = ''
        if (value !== undefined)
            reflectionMergePartial<AttributeContext_Request>(
                this,
                message,
                value
            )
    ...
    internalBinaryRead(
        ...
        length: number,
        options: BinaryReadOptions,
        target?: AttributeContext_Request
    ): AttributeContext_Request {
        let message = target ?? this.create(),
            end = reader.pos + length
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.rpc.context.AttributeContext.Auth auth */ 13:
                    message.auth = AttributeContext_Auth.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.auth
    ...
    private binaryReadMap3(
        map: AttributeContext_Request['headers'],
        reader: IBinaryReader,
        options: BinaryReadOptions
    ): void {
        let len = reader.uint32(),
            end = reader.pos + len,
            key: keyof AttributeContext_Request['headers'] | undefined,
            val: AttributeContext_Request['headers'][any] | undefined
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag()
            switch (fieldNo) {
                case 1:
                ...
                default:
                    throw new globalThis.Error(
                        'unknown map entry field for google.rpc.context.AttributeContext.Request.headers'
                    )
            }
        }
        map[key ?? ''] = val ?? ''
    ...
    internalBinaryWrite(
        ...
        if (message.auth)
            AttributeContext_Auth.internalBinaryWrite(
                message.auth,
...
class AttributeContext_Response$Type extends MessageType<AttributeContext_Response> {
    ...
    create(
        value?: PartialMessage<AttributeContext_Response>
        ...
        message.headers = {}
        if (value !== undefined)
            reflectionMergePartial<AttributeContext_Response>(
                this,
                message,
                value
            )
    ...
    internalBinaryRead(
        ...
        length: number,
        options: BinaryReadOptions,
        target?: AttributeContext_Response
    ): AttributeContext_Response {
        let message = target ?? this.create(),
            end = reader.pos + length
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.protobuf.Duration backend_latency */ 5:
                    message.backendLatency = Duration.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
    ...
    private binaryReadMap3(
        map: AttributeContext_Response['headers'],
        reader: IBinaryReader,
        options: BinaryReadOptions
    ): void {
        let len = reader.uint32(),
            end = reader.pos + len,
            key: keyof AttributeContext_Response['headers'] | undefined,
            val: AttributeContext_Response['headers'][any] | undefined
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag()
            switch (fieldNo) {
                case 1:
                ...
                default:
                    throw new globalThis.Error(
                        'unknown map entry field for google.rpc.context.AttributeContext.Response.headers'
                    )
            }
        }
        map[key ?? ''] = val ?? ''
...
class AttributeContext_Resource$Type extends MessageType<AttributeContext_Resource> {
    ...
    create(
        value?: PartialMessage<AttributeContext_Resource>
        ...
        message.location = ''
        if (value !== undefined)
            reflectionMergePartial<AttributeContext_Resource>(
                this,
                message,
                value
            )
    ...
    internalBinaryRead(
        ...
        length: number,
        options: BinaryReadOptions,
        target?: AttributeContext_Resource
    ): AttributeContext_Resource {
        let message = target ?? this.create(),
            end = reader.pos + length
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.protobuf.Timestamp delete_time */ 10:
                    message.deleteTime = Timestamp.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.deleteTime
    ...
    private binaryReadMap4(
        map: AttributeContext_Resource['labels'],
        reader: IBinaryReader,
        options: BinaryReadOptions
    ): void {
        let len = reader.uint32(),
            end = reader.pos + len,
            key: keyof AttributeContext_Resource['labels'] | undefined,
            val: AttributeContext_Resource['labels'][any] | undefined
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag()
            switch (fieldNo) {
                case 1:
                ...
                default:
                    throw new globalThis.Error(
                        'unknown map entry field for google.rpc.context.AttributeContext.Resource.labels'
                    )
            }
        }
        map[key ?? ''] = val ?? ''
    ...
    private binaryReadMap6(
        map: AttributeContext_Resource['annotations'],
        reader: IBinaryReader,
        options: BinaryReadOptions
    ): void {
        let len = reader.uint32(),
            end = reader.pos + len,
            key: keyof AttributeContext_Resource['annotations'] | undefined,
            val: AttributeContext_Resource['annotations'][any] | undefined
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag()
            switch (fieldNo) {
                case 1:
                ...
                default:
                    throw new globalThis.Error(
                        'unknown map entry field for google.rpc.context.AttributeContext.Resource.annotations'
                    )
            }
        }
        map[key ?? ''] = val ?? ''
