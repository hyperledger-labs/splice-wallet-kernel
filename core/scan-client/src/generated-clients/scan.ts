...
export interface paths {
    '/readyz': external['../../../../common/src/main/openapi/common-external.yaml']['paths']['/readyz']
    '/livez': external['../../../../common/src/main/openapi/common-external.yaml']['paths']['/livez']
    '/status': external['../../../../common/src/main/openapi/common-external.yaml']['paths']['/status']
    '/version': external['../../../../common/src/main/openapi/common-external.yaml']['paths']['/version']
    '/v0/dso': {
...
export interface components {
    schemas: {
        ...
        GetClosedRoundsResponse: {
             ...
             */
            rounds: external['../../../../common/src/main/openapi/common-external.yaml']['components']['schemas']['Contract'][]
        }
        GetOpenAndIssuingMiningRoundsRequest: {
             ...
             * penalty is incurred.
             */
            cached_open_mining_round_contract_ids: external['../../../../common/src/main/openapi/common-external.yaml']['components']['schemas']['ContractId'][]
            /**
             ...
             */
            cached_issuing_round_contract_ids: external['../../../../common/src/main/openapi/common-external.yaml']['components']['schemas']['ContractId'][]
        }
        /**
        ...
        GetOpenAndIssuingMiningRoundsResponse: {
            ...
            open_mining_rounds: external['../../../../common/src/main/openapi/common-internal.yaml']['components']['schemas']['MaybeCachedContractWithStateMap']
            issuing_mining_rounds: external['../../../../common/src/main/openapi/common-internal.yaml']['components']['schemas']['MaybeCachedContractWithStateMap']
        }
        GetAmuletRulesRequest: {
            cached_amulet_rules_contract_id?: external['../../../../common/src/main/openapi/common-external.yaml']['components']['schemas']['ContractId']
        ...
        GetAmuletRulesResponse: {
            amulet_rules_update: external['../../../../common/src/main/openapi/common-internal.yaml']['components']['schemas']['MaybeCachedContractWithState']
        }
        GetExternalPartyAmuletRulesRequest: {
            cached_external_party_amulet_rules_contract_id?: external['../../../../common/src/main/openapi/common-external.yaml']['components']['schemas']['ContractId']
        ...
        GetExternalPartyAmuletRulesResponse: {
            external_party_amulet_rules_update: external['../../../../common/src/main/openapi/common-internal.yaml']['components']['schemas']['MaybeCachedContractWithState']
        }
        GetAnsRulesRequest: {
            cached_ans_rules_contract_id?: external['../../../../common/src/main/openapi/common-external.yaml']['components']['schemas']['ContractId']
            cached_ans_rules_domain_id?: string
        }
        /** @description A contract state update of Daml template `Splice.Ans.AnsRules`. */
        GetAnsRulesResponse: {
            ans_rules_update: external['../../../../common/src/main/openapi/common-internal.yaml']['components']['schemas']['MaybeCachedContractWithState']
        }
        /** @description Contracts of Daml template `Splice.Amulet.FeaturedAppRight`. */
        ListFeaturedAppRightsResponse: {
            featured_apps: external['../../../../common/src/main/openapi/common-external.yaml']['components']['schemas']['Contract'][]
        }
        /** @description If defined, a contract of Daml template `Splice.Amulet.FeaturedAppRight`. */
        LookupFeaturedAppRightResponse: {
            featured_app_right?: external['../../../../common/src/main/openapi/common-external.yaml']['components']['schemas']['Contract']
        }
        ...
        LookupTransferPreapprovalByPartyResponse: {
            transfer_preapproval: external['../../../../common/src/main/openapi/common-internal.yaml']['components']['schemas']['ContractWithState']
        }
        ...
        LookupTransferCommandCounterByPartyResponse: {
            transfer_command_counter: external['../../../../common/src/main/openapi/common-internal.yaml']['components']['schemas']['ContractWithState']
        }
        ...
        TransferCommandContractWithStatus: {
            contract: external['../../../../common/src/main/openapi/common-external.yaml']['components']['schemas']['Contract']
        ...
        TransferCommandCreatedResponse: {
            status: 'created'
        } & components['schemas']['BaseLookupTransferCommandStatusResponse']
...
export interface external {
    '../../../../common/src/main/openapi/common-external.yaml': {
        paths: {
            '/status': {
        ...
        components: {
            schemas: {
                ...
                SuccessStatusResponse: {
                    success: external['../../../../common/src/main/openapi/common-external.yaml']['components']['schemas']['Status']
                }
                NotInitializedStatusResponse: {
                    not_initialized: external['../../../../common/src/main/openapi/common-external.yaml']['components']['schemas']['NotInitialized']
                }
                FailureStatusResponse: {
                    failed: external['../../../../common/src/main/openapi/common-external.yaml']['components']['schemas']['ErrorResponse']
                }
                NodeStatus:
                    | external['../../../../common/src/main/openapi/common-external.yaml']['components']['schemas']['SuccessStatusResponse']
                    | external['../../../../common/src/main/openapi/common-external.yaml']['components']['schemas']['NotInitializedStatusResponse']
                    | external['../../../../common/src/main/openapi/common-external.yaml']['components']['schemas']['FailureStatusResponse']
                Version: {
                    version: string
                    /** Format: date-time */
                    commit_ts: string
            ...
            responses: {
                ...
                400: {
                    content: {
                        'application/json': external['../../../../common/src/main/openapi/common-external.yaml']['components']['schemas']['ErrorResponse']
                    }
                }
    ...
    '../../../../common/src/main/openapi/common-internal.yaml': {
        ...
        components: {
            schemas: {
                ...
                MaybeCachedContractMap: {
                    [
                        key: string
                    ]: external['../../../../common/src/main/openapi/common-internal.yaml']['components']['schemas']['MaybeCachedContract']
                }
                /**
                ...
                MaybeCachedContractWithStateMap: {
                    [
                        key: string
                    ]: external['../../../../common/src/main/openapi/common-internal.yaml']['components']['schemas']['MaybeCachedContractWithState']
                }
                NodeIdentitiesDump: {
                    id: string
                    keys: external['../../../../common/src/main/openapi/common-internal.yaml']['components']['schemas']['NodeKey'][]
                    /** @description base64 encoded string of authorized store snapshot */
                    authorizedStoreSnapshot: string
                    version?: string
                }
                NodeKey:
                    | external['../../../../common/src/main/openapi/common-internal.yaml']['components']['schemas']['KeyPair']
                    | external['../../../../common/src/main/openapi/common-internal.yaml']['components']['schemas']['KmsKeyId']
                KeyPair: {
                    keyPair: string
                    name?: string
                }
                ...
                ParticipantUsersData: {
                    identityProviders: external['../../../../common/src/main/openapi/common-internal.yaml']['components']['schemas']['ParticipantIdentityProvider'][]
                    users: external['../../../../common/src/main/openapi/common-internal.yaml']['components']['schemas']['ParticipantUser'][]
                }
                ...
                ParticipantUser: {
                    id: string
                    primaryParty?: string
                    rights: external['../../../../common/src/main/openapi/common-internal.yaml']['components']['schemas']['ParticipantUserRight'][]
                    /** @default false */
                    isDeactivated: boolean
                    annotations: external['../../../../common/src/main/openapi/common-internal.yaml']['components']['schemas']['ParticipantUserAnnotation'][]
                    /** @default */
                ...
                GetDsoInfoResponse: {
                     ...
                     */
                    latest_mining_round: external['../../../../common/src/main/openapi/common-internal.yaml']['components']['schemas']['ContractWithState']
                    /**
                     * @description Contract of the Daml template `Splice.AmuletRules.AmuletRules`,
                     * including the full schedule of `AmuletConfig` changes approved by
                     * the DSO. Callers should not assume that `initialValue` is up-to-date,
                     ...
                     * valid as of now
                     */
                    amulet_rules: external['../../../../common/src/main/openapi/common-internal.yaml']['components']['schemas']['ContractWithState']
                    /**
                     ...
                     */
                    dso_rules: external['../../../../common/src/main/openapi/common-internal.yaml']['components']['schemas']['ContractWithState']
                    /**
                     ...
                     * state contract
                     */
                    sv_node_states: external['../../../../common/src/main/openapi/common-internal.yaml']['components']['schemas']['ContractWithState'][]
                ...
                ListVoteRequestByTrackingCidResponse: {
                     ...
                     */
                    vote_requests: external['../../../../common/src/main/openapi/common-external.yaml']['components']['schemas']['Contract'][]
                }
                /** @description A contract of Daml template `Splice.DsoRules:VoteRequest`. */
                LookupDsoRulesVoteRequestResponse: {
                    dso_rules_vote_request: external['../../../../common/src/main/openapi/common-external.yaml']['components']['schemas']['Contract']
                }
                /** @description Contracts of Daml template `Splice.DsoRules:VoteRequest`. */
                ListDsoRulesVoteRequestsResponse: {
                    dso_rules_vote_requests: external['../../../../common/src/main/openapi/common-external.yaml']['components']['schemas']['Contract'][]
                }
                /** @description Contracts of Daml template `Splice.DSO:AmuletPrice:AmuletPriceVote`. */
                ListAmuletPriceVotesResponse: {
                    amulet_price_votes: external['../../../../common/src/main/openapi/common-external.yaml']['components']['schemas']['Contract'][]
                }
                ...
                ListValidatorLicensesResponse: {
                    ...
                    validator_licenses: external['../../../../common/src/main/openapi/common-external.yaml']['components']['schemas']['Contract'][]
                    /**
                     * Format: int64
...
export interface operations {
    getDsoInfo: {
        responses: {
            ...
            200: {
                content: {
                    'application/json': external['../../../../common/src/main/openapi/common-internal.yaml']['components']['schemas']['GetDsoInfoResponse']
                }
            }
        }
    }
    ...
    getValidatorFaucetsByValidator: {
        ...
        responses: {
            ...
            400: external['../../../../common/src/main/openapi/common-external.yaml']['components']['responses']['400']
            404: external['../../../../common/src/main/openapi/common-external.yaml']['components']['responses']['404']
        }
    }
    /**
     * @description Retrieve Canton scan configuration for all SVs, grouped by
    ...
    listValidatorLicenses: {
        ...
        responses: {
            ...
            200: {
                content: {
                    'application/json': external['../../../../common/src/main/openapi/common-internal.yaml']['components']['schemas']['ListValidatorLicensesResponse']
                }
            }
        }
    }
    ...
    getPartyToParticipant: {
        ...
        responses: {
            ...
            404: external['../../../../common/src/main/openapi/common-external.yaml']['components']['responses']['404']
            500: external['../../../../common/src/main/openapi/common-external.yaml']['components']['responses']['500']
        }
    }
    /**
     * @description Get a member's traffic status as reported by the sequencer, according to
    ...
    listAmuletPriceVotes: {
        responses: {
            ...
            200: {
                content: {
                    'application/json': external['../../../../common/src/main/openapi/common-internal.yaml']['components']['schemas']['ListAmuletPriceVotesResponse']
                }
            }
        }
    }
    ...
    listVoteRequestsByTrackingCid: {
        requestBody: {
            content: {
                'application/json': external['../../../../common/src/main/openapi/common-internal.yaml']['components']['schemas']['BatchListVotesByVoteRequestsRequest']
            }
        }
        responses: {
            /** @description ok */
            200: {
                content: {
                    'application/json': external['../../../../common/src/main/openapi/common-internal.yaml']['components']['schemas']['ListVoteRequestByTrackingCidResponse']
                }
            }
        }
    }
    ...
    lookupDsoRulesVoteRequest: {
        ...
        responses: {
            ...
            200: {
                content: {
                    'application/json': external['../../../../common/src/main/openapi/common-internal.yaml']['components']['schemas']['LookupDsoRulesVoteRequestResponse']
                }
            }
    ...
    listDsoRulesVoteRequests: {
        responses: {
            ...
            200: {
                content: {
                    'application/json': external['../../../../common/src/main/openapi/common-internal.yaml']['components']['schemas']['ListDsoRulesVoteRequestsResponse']
                }
            }
        }
    }
    listVoteRequestResults: {
        requestBody: {
            content: {
                'application/json': external['../../../../common/src/main/openapi/common-internal.yaml']['components']['schemas']['ListVoteResultsRequest']
            }
        }
        responses: {
            /** @description ok */
            200: {
                content: {
                    'application/json': external['../../../../common/src/main/openapi/common-internal.yaml']['components']['schemas']['ListDsoRulesVoteResultsResponse']
                }
            }
        }
    }
    ...
    featureSupport: {
        responses: {
            ...
            200: {
                content: {
                    'application/json': external['../../../../common/src/main/openapi/common-internal.yaml']['components']['schemas']['FeatureSupportResponse']
                }
            }
            500: external['../../../../common/src/main/openapi/common-external.yaml']['components']['responses']['500']
        }
    ...
    getHealthStatus: {
        responses: {
            ...
            200: {
                content: {
                    'application/json': external['../../../../common/src/main/openapi/common-external.yaml']['components']['schemas']['NodeStatus']
                }
            }
        }
    }
    getVersion: {
        responses: {
            ...
            200: {
                content: {
                    'application/json': external['../../../../common/src/main/openapi/common-external.yaml']['components']['schemas']['Version']
                }
            }
        }
    }
