...
export interface ParticipantAuthorizationOnboarding {
    value: ParticipantAuthorizationOnboarding1
}
export interface ParticipantAuthorizationOnboarding1 {
    /** Required **/
    partyId: string
    /** Required **/
    participantId: string
...
export declare const CHANNELS: {
    ...
    v2_state_active_contracts: '/v2/state/active-contracts'
    v2_updates: '/v2/updates'
    v2_updates_flats: '/v2/updates/flats'
    v2_updates_trees: '/v2/updates/trees'
}
export declare const API_INFO: {
    readonly title: 'JSON Ledger API WebSocket endpoints'
    readonly version: '3.5.1-SNAPSHOT'
    readonly description: 'This specification version fixes the API inconsistencies where certain fields marked as required in the spec are in fact optional.\nIf you use code generation tool based on this file, you might need to adjust the existing application code to handle those fields as optional.\nIf you do not want to change your client code, continue using the OpenAPI specification for the latest Canton 3.4 patch release.\nMINIMUM_CANTON_VERSION=3.5.1'
}
//# sourceMappingURL=asyncapi-3.5.1.d.ts.map
