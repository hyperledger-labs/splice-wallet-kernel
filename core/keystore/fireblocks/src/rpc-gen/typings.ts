...
export interface ObjectOfStringX1AtUghPStringQ5XJO2DaStringYbbTuhoeStringRqVz1Pmx8GCErVWM {
    tx: StringQ5XJO2Da
 ...
 *
 */
export type  =

        | ObjectOfStringX1AtUghPStringQ5XJO2DaStringYbbTuhoeStringRqVz1Pmx8GCErVWM
...
export type SignTransaction = (
    params: ObjectOfStringX1AtUghPStringQ5XJO2DaStringYbbTuhoeStringRqVz1Pmx8GCErVWM
