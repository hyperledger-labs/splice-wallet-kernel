...
class GetCommandStatusRequest$Type extends MessageType<GetCommandStatusRequest> {
    ...
    create(value?: PartialMessage<GetCommandStatusRequest>): GetCommandStatusRequest {
        ...
        message.limit = 0;
        if (value !== undefined)
            reflectionMergePartial<GetCommandStatusRequest>(this, message, value);
        return message;
    }
    ...
    internalBinaryWrite(message: GetCommandStatusRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.commandIdPrefix !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.commandIdPrefix);
...
class GetCommandStatusResponse$Type extends MessageType<GetCommandStatusResponse> {
    ...
    create(value?: PartialMessage<GetCommandStatusResponse>): GetCommandStatusResponse {
        ...
        if (value !== undefined)
            reflectionMergePartial<GetCommandStatusResponse>(this, message, value);
        return message;
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* com.daml.ledger.api.v2.admin.RequestStatistics request_statistics */ 6:
                    message.requestStatistics = RequestStatistics.internalBinaryRead(reader, reader.uint32(), options, message.requestStatistics);
                    break;
