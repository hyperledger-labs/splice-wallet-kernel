        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* com.daml.ledger.api.v2.CreatedEvent created */ 1:
                    message.event = {
                        oneofKind: "created",
                        created: CreatedEvent.internalBinaryRead(reader, reader.uint32(), options, (message.event as any).created)
                    };
                    break;
                case /* com.daml.ledger.api.v2.ArchivedEvent archived */ 2:
                    message.event = {
                        oneofKind: "archived",
                        archived: ArchivedEvent.internalBinaryRead(reader, reader.uint32(), options, (message.event as any).archived)
                    };
                    break;
                case /* com.daml.ledger.api.v2.ExercisedEvent exercised */ 3:
                    message.event = {
                        oneofKind: "exercised",
                        exercised: ExercisedEvent.internalBinaryRead(reader, reader.uint32(), options, (message.event as any).exercised)
                    };
                    break;
                default:
...
class CreatedEvent$Type extends MessageType<CreatedEvent> {
    ...
    internalBinaryWrite(message: CreatedEvent, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.createdEventBlob.length)
            writer.tag(7, WireType.LengthDelimited).bytes(message.createdEventBlob);
        ...
        for (let i = 0; i < message.signatories.length; i++)
            writer.tag(10, WireType.LengthDelimited).string(message.signatories[i]);
        /* repeated string observers = 11; */
        for (let i = 0; i < message.observers.length; i++)
            writer.tag(11, WireType.LengthDelimited).string(message.observers[i]);
...
class ArchivedEvent$Type extends MessageType<ArchivedEvent> {
    ...
    internalBinaryWrite(message: ArchivedEvent, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.witnessParties.length; i++)
            writer.tag(5, WireType.LengthDelimited).string(message.witnessParties[i]);
...
class ExercisedEvent$Type extends MessageType<ExercisedEvent> {
    ...
    internalBinaryWrite(message: ExercisedEvent, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.actingParties.length; i++)
            writer.tag(8, WireType.LengthDelimited).string(message.actingParties[i]);
        /* bool consuming = 9; */
        if (message.consuming !== false)
            writer.tag(9, WireType.Varint).bool(message.consuming);
        /* repeated string witness_parties = 10; */
        for (let i = 0; i < message.witnessParties.length; i++)
            writer.tag(10, WireType.LengthDelimited).string(message.witnessParties[i]);
