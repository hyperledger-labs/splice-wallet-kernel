...
export const Metadata: MessageFns<Metadata> = {
  encode(message: Metadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.preparationTime !== 0) {
      writer.uint32(48).uint64(message.preparationTime);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6: {
          ...
          message.preparationTime = longToNumber(reader.uint64());
          continue;
        }
        case 7: {
          if (tag !== 58) {
  ...
  fromJSON(object: any): Metadata {
    return {
      ...
      preparationTime: isSet(object.preparationTime) ? gt.Number(object.preparationTime) : 0,
  ...
  toJSON(message: Metadata): unknown {
    ...
    if (message.preparationTime !== 0) {
      obj.preparationTime = Math.round(message.preparationTime);
    }
  ...
  fromPartial<I extends Exact<DeepPartial<Metadata>, I>>(object: I): Metadata {
    ...
    message.preparationTime = object.preparationTime ?? 0;
...
function createBaseMetadata_InputContract(): Metadata_InputContract {
  return { v1: undefined, createdAt: 0, eventBlob: new Uint8Array(0) };
}
...
export const Metadata_InputContract: MessageFns<Metadata_InputContract> = {
  encode(message: Metadata_InputContract, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.eventBlob.length !== 0) {
      writer.uint32(8018).bytes(message.eventBlob);
    }
    return writer;
  },
  ...
  fromJSON(object: any): Metadata_InputContract {
    return {
      ...
      eventBlob: isSet(object.eventBlob) ? bytesFromBase64(object.eventBlob) : new Uint8Array(0),
    };
  },
  ...
  toJSON(message: Metadata_InputContract): unknown {
    ...
    if (message.eventBlob.length !== 0) {
      obj.eventBlob = base64FromBytes(message.eventBlob);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Metadata_InputContract>, I>>(object: I): Metadata_InputContract {
    ...
    message.eventBlob = object.eventBlob ?? new Uint8Array(0);
    return message;
  },
};
