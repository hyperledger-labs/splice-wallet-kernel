...
class GetLedgerApiVersionRequest$Type extends MessageType<GetLedgerApiVersionRequest> {
    ...
    create(value?: PartialMessage<GetLedgerApiVersionRequest>): GetLedgerApiVersionRequest {
        ...
        if (value !== undefined)
            reflectionMergePartial<GetLedgerApiVersionRequest>(this, message, value);
        return message;
    }
...
class GetLedgerApiVersionResponse$Type extends MessageType<GetLedgerApiVersionResponse> {
    ...
    create(value?: PartialMessage<GetLedgerApiVersionResponse>): GetLedgerApiVersionResponse {
        ...
        message.version = "";
        if (value !== undefined)
            reflectionMergePartial<GetLedgerApiVersionResponse>(this, message, value);
        return message;
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* com.daml.ledger.api.v2.ExperimentalFeatures experimental */ 1:
                    message.experimental = ExperimentalFeatures.internalBinaryRead(reader, reader.uint32(), options, message.experimental);
                    break;
                case /* com.daml.ledger.api.v2.UserManagementFeature user_management */ 2:
                    message.userManagement = UserManagementFeature.internalBinaryRead(reader, reader.uint32(), options, message.userManagement);
                    break;
                case /* com.daml.ledger.api.v2.PartyManagementFeature party_management */ 3:
                    message.partyManagement = PartyManagementFeature.internalBinaryRead(reader, reader.uint32(), options, message.partyManagement);
                    break;
                case /* com.daml.ledger.api.v2.OffsetCheckpointFeature offset_checkpoint */ 4:
                    message.offsetCheckpoint = OffsetCheckpointFeature.internalBinaryRead(reader, reader.uint32(), options, message.offsetCheckpoint);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
...
class OffsetCheckpointFeature$Type extends MessageType<OffsetCheckpointFeature> {
    ...
    create(value?: PartialMessage<OffsetCheckpointFeature>): OffsetCheckpointFeature {
        const message = globalThis.Object.create((this.messagePrototype!));
        if (value !== undefined)
            reflectionMergePartial<OffsetCheckpointFeature>(this, message, value);
        return message;
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* google.protobuf.Duration max_offset_checkpoint_emission_delay */ 1:
                    message.maxOffsetCheckpointEmissionDelay = Duration.internalBinaryRead(reader, reader.uint32(), options, message.maxOffsetCheckpointEmissionDelay);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
