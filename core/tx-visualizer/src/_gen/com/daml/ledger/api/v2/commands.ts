...
class Command$Type extends MessageType<Command> {
    constructor() {
        super("com.daml.ledger.api.v2.Command", [
            { no: 1, name: "create", kind: "message", oneof: "command", T: () => CreateCommand },
            { no: 2, name: "exercise", kind: "message", oneof: "command", T: () => ExerciseCommand },
            { no: 4, name: "exercise_by_key", kind: "message", oneof: "command", T: () => ExerciseByKeyCommand },
            { no: 3, name: "create_and_exercise", kind: "message", oneof: "command", T: () => CreateAndExerciseCommand }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* com.daml.ledger.api.v2.CreateCommand create */ 1:
                    message.command = {
                        oneofKind: "create",
                        create: CreateCommand.internalBinaryRead(reader, reader.uint32(), options, (message.command as any).create)
                    };
                    break;
                case /* com.daml.ledger.api.v2.ExerciseCommand exercise */ 2:
                    message.command = {
                        oneofKind: "exercise",
                        exercise: ExerciseCommand.internalBinaryRead(reader, reader.uint32(), options, (message.command as any).exercise)
                    };
                    break;
                case /* com.daml.ledger.api.v2.ExerciseByKeyCommand exercise_by_key */ 4:
                    message.command = {
                        oneofKind: "exerciseByKey",
                        exerciseByKey: ExerciseByKeyCommand.internalBinaryRead(reader, reader.uint32(), options, (message.command as any).exerciseByKey)
                    };
                    break;
                case /* com.daml.ledger.api.v2.CreateAndExerciseCommand create_and_exercise */ 3:
                    message.command = {
                        oneofKind: "createAndExercise",
                        createAndExercise: CreateAndExerciseCommand.internalBinaryRead(reader, reader.uint32(), options, (message.command as any).createAndExercise)
                    };
                    break;
                default:
...
class CreateCommand$Type extends MessageType<CreateCommand> {
    constructor() {
        super("com.daml.ledger.api.v2.CreateCommand", [
            ...
            { no: 2, name: "create_arguments", kind: "message", T: () => Record }
        ]);
    }
...
class CreateAndExerciseCommand$Type extends MessageType<CreateAndExerciseCommand> {
    ...
    create(value?: PartialMessage<CreateAndExerciseCommand>): CreateAndExerciseCommand {
        ...
        message.choice = "";
        if (value !== undefined)
            reflectionMergePartial<CreateAndExerciseCommand>(this, message, value);
        return message;
    }
...
class DisclosedContract$Type extends MessageType<DisclosedContract> {
    constructor() {
        super("com.daml.ledger.api.v2.DisclosedContract", [
            { no: 1, name: "template_id", kind: "message", T: () => Identifier },
            { no: 2, name: "contract_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "created_event_blob", kind: "scalar", T: 12 /*ScalarType.BYTES*/ },
    ...
    internalBinaryWrite(message: DisclosedContract, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.createdEventBlob.length)
            writer.tag(3, WireType.LengthDelimited).bytes(message.createdEventBlob);
        /* string synchronizer_id = 4; */
        if (message.synchronizerId !== "")
            writer.tag(4, WireType.LengthDelimited).string(message.synchronizerId);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class Commands$Type extends MessageType<Commands> {
    constructor() {
        super("com.daml.ledger.api.v2.Commands", [
            ...
            { no: 4, name: "commands", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Command },
            { no: 5, name: "deduplication_duration", kind: "message", oneof: "deduplicationPeriod", T: () => Duration },
            { no: 6, name: "deduplication_offset", kind: "scalar", oneof: "deduplicationPeriod", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 7, name: "min_ledger_time_abs", kind: "message", T: () => Timestamp },
            { no: 8, name: "min_ledger_time_rel", kind: "message", T: () => Duration },
            { no: 9, name: "act_as", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 10, name: "read_as", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 11, name: "submission_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 12, name: "disclosed_contracts", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => DisclosedContract },
            { no: 13, name: "synchronizer_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 14, name: "package_id_selection_preference", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
    ...
    internalBinaryWrite(message: Commands, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.deduplicationPeriod.oneofKind === "deduplicationOffset")
            writer.tag(6, WireType.Varint).int64(message.deduplicationPeriod.deduplicationOffset);
        ...
        if (message.submissionId !== "")
            writer.tag(11, WireType.LengthDelimited).string(message.submissionId);
        ...
        if (message.synchronizerId !== "")
            writer.tag(13, WireType.LengthDelimited).string(message.synchronizerId);
        /* repeated string package_id_selection_preference = 14; */
        for (let i = 0; i < message.packageIdSelectionPreference.length; i++)
            writer.tag(14, WireType.LengthDelimited).string(message.packageIdSelectionPreference[i]);
