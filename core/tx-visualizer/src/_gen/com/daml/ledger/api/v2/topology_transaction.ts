...
import { ParticipantPermission } from "./state_service";
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* com.daml.ledger.api.v2.ParticipantAuthorizationChanged participant_authorization_changed */ 1:
                    message.event = {
                        oneofKind: "participantAuthorizationChanged",
                        participantAuthorizationChanged: ParticipantAuthorizationChanged.internalBinaryRead(reader, reader.uint32(), options, (message.event as any).participantAuthorizationChanged)
                    };
                    break;
                case /* com.daml.ledger.api.v2.ParticipantAuthorizationRevoked participant_authorization_revoked */ 2:
                    message.event = {
                        oneofKind: "participantAuthorizationRevoked",
                        participantAuthorizationRevoked: ParticipantAuthorizationRevoked.internalBinaryRead(reader, reader.uint32(), options, (message.event as any).participantAuthorizationRevoked)
                    };
                    break;
                case /* com.daml.ledger.api.v2.ParticipantAuthorizationAdded participant_authorization_added */ 3:
                    message.event = {
                        oneofKind: "participantAuthorizationAdded",
                        participantAuthorizationAdded: ParticipantAuthorizationAdded.internalBinaryRead(reader, reader.uint32(), options, (message.event as any).participantAuthorizationAdded)
                    };
                    break;
                default:
                    let u = options.readUnknownField;
...
class ParticipantAuthorizationAdded$Type extends MessageType<ParticipantAuthorizationAdded> {
    ...
    create(value?: PartialMessage<ParticipantAuthorizationAdded>): ParticipantAuthorizationAdded {
        ...
        if (value !== undefined)
            reflectionMergePartial<ParticipantAuthorizationAdded>(this, message, value);
        return message;
    }
...
class ParticipantAuthorizationChanged$Type extends MessageType<ParticipantAuthorizationChanged> {
    ...
    create(value?: PartialMessage<ParticipantAuthorizationChanged>): ParticipantAuthorizationChanged {
        ...
        message.participantPermission = 0;
        if (value !== undefined)
            reflectionMergePartial<ParticipantAuthorizationChanged>(this, message, value);
        return message;
    }
...
class ParticipantAuthorizationRevoked$Type extends MessageType<ParticipantAuthorizationRevoked> {
    ...
    create(value?: PartialMessage<ParticipantAuthorizationRevoked>): ParticipantAuthorizationRevoked {
        ...
        message.participantId = "";
        if (value !== undefined)
            reflectionMergePartial<ParticipantAuthorizationRevoked>(this, message, value);
        return message;
    }
