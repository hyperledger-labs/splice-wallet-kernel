...
import { AssignedEvent } from "./reassignment";
import { UnassignedEvent } from "./reassignment";
...
class GetActiveContractsRequest$Type extends MessageType<GetActiveContractsRequest> {
    constructor() {
        super("com.daml.ledger.api.v2.GetActiveContractsRequest", [
            ...
            { no: 3, name: "active_at_offset", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
    ...
    create(value?: PartialMessage<GetActiveContractsRequest>): GetActiveContractsRequest {
        ...
        if (value !== undefined)
            reflectionMergePartial<GetActiveContractsRequest>(this, message, value);
        return message;
    }
...
class GetActiveContractsResponse$Type extends MessageType<GetActiveContractsResponse> {
    ...
    create(value?: PartialMessage<GetActiveContractsResponse>): GetActiveContractsResponse {
        ...
        if (value !== undefined)
            reflectionMergePartial<GetActiveContractsResponse>(this, message, value);
        return message;
    }
            ...
            switch (fieldNo) {
                ...
                case /* com.daml.ledger.api.v2.ActiveContract active_contract */ 2:
                    message.contractEntry = {
                        oneofKind: "activeContract",
                        activeContract: ActiveContract.internalBinaryRead(reader, reader.uint32(), options, (message.contractEntry as any).activeContract)
                    };
                    break;
                case /* com.daml.ledger.api.v2.IncompleteUnassigned incomplete_unassigned */ 3:
                    message.contractEntry = {
                        oneofKind: "incompleteUnassigned",
                        incompleteUnassigned: IncompleteUnassigned.internalBinaryRead(reader, reader.uint32(), options, (message.contractEntry as any).incompleteUnassigned)
                    };
                    break;
                case /* com.daml.ledger.api.v2.IncompleteAssigned incomplete_assigned */ 4:
                    message.contractEntry = {
                        oneofKind: "incompleteAssigned",
                        incompleteAssigned: IncompleteAssigned.internalBinaryRead(reader, reader.uint32(), options, (message.contractEntry as any).incompleteAssigned)
                    };
                    break;
                default:
                    let u = options.readUnknownField;
...
class ActiveContract$Type extends MessageType<ActiveContract> {
    constructor() {
        super("com.daml.ledger.api.v2.ActiveContract", [
            ...
            { no: 3, name: "reassignment_counter", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* com.daml.ledger.api.v2.UnassignedEvent unassigned_event */ 2:
                    message.unassignedEvent = UnassignedEvent.internalBinaryRead(reader, reader.uint32(), options, message.unassignedEvent);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
...
class GetConnectedSynchronizersRequest$Type extends MessageType<GetConnectedSynchronizersRequest> {
    ...
    create(value?: PartialMessage<GetConnectedSynchronizersRequest>): GetConnectedSynchronizersRequest {
        ...
        if (value !== undefined)
            reflectionMergePartial<GetConnectedSynchronizersRequest>(this, message, value);
        return message;
    }
...
class GetConnectedSynchronizersResponse$Type extends MessageType<GetConnectedSynchronizersResponse> {
    ...
    create(value?: PartialMessage<GetConnectedSynchronizersResponse>): GetConnectedSynchronizersResponse {
        ...
        if (value !== undefined)
            reflectionMergePartial<GetConnectedSynchronizersResponse>(this, message, value);
        return message;
    }
...
class GetConnectedSynchronizersResponse_ConnectedSynchronizer$Type extends MessageType<GetConnectedSynchronizersResponse_ConnectedSynchronizer> {
    ...
    create(value?: PartialMessage<GetConnectedSynchronizersResponse_ConnectedSynchronizer>): GetConnectedSynchronizersResponse_ConnectedSynchronizer {
        ...
        if (value !== undefined)
            reflectionMergePartial<GetConnectedSynchronizersResponse_ConnectedSynchronizer>(this, message, value);
        return message;
    }
    ...
    internalBinaryWrite(message: GetConnectedSynchronizersResponse_ConnectedSynchronizer, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.synchronizerAlias !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.synchronizerAlias);
        /* string synchronizer_id = 2; */
        if (message.synchronizerId !== "")
            writer.tag(2, WireType.LengthDelimited).string(message.synchronizerId);
...
class GetLatestPrunedOffsetsRequest$Type extends MessageType<GetLatestPrunedOffsetsRequest> {
    ...
    create(value?: PartialMessage<GetLatestPrunedOffsetsRequest>): GetLatestPrunedOffsetsRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        if (value !== undefined)
            reflectionMergePartial<GetLatestPrunedOffsetsRequest>(this, message, value);
        return message;
    }
...
class GetLatestPrunedOffsetsResponse$Type extends MessageType<GetLatestPrunedOffsetsResponse> {
    constructor() {
        super("com.daml.ledger.api.v2.GetLatestPrunedOffsetsResponse", [
            { no: 1, name: "participant_pruned_up_to_inclusive", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 2, name: "all_divulged_contracts_pruned_up_to_inclusive", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
    create(value?: PartialMessage<GetLatestPrunedOffsetsResponse>): GetLatestPrunedOffsetsResponse {
        ...
        if (value !== undefined)
            reflectionMergePartial<GetLatestPrunedOffsetsResponse>(this, message, value);
        return message;
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* int64 participant_pruned_up_to_inclusive */ 1:
                    message.participantPrunedUpToInclusive = reader.int64().toBigInt();
                    break;
                case /* int64 all_divulged_contracts_pruned_up_to_inclusive */ 2:
                    message.allDivulgedContractsPrunedUpToInclusive = reader.int64().toBigInt();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: GetLatestPrunedOffsetsResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.participantPrunedUpToInclusive !== 0n)
            writer.tag(1, WireType.Varint).int64(message.participantPrunedUpToInclusive);
        /* int64 all_divulged_contracts_pruned_up_to_inclusive = 2; */
        if (message.allDivulgedContractsPrunedUpToInclusive !== 0n)
            writer.tag(2, WireType.Varint).int64(message.allDivulgedContractsPrunedUpToInclusive);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
