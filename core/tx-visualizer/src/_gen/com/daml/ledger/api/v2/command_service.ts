...
class SubmitAndWaitForTransactionRequest$Type extends MessageType<SubmitAndWaitForTransactionRequest> {
    ...
    create(value?: PartialMessage<SubmitAndWaitForTransactionRequest>): SubmitAndWaitForTransactionRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        if (value !== undefined)
            reflectionMergePartial<SubmitAndWaitForTransactionRequest>(this, message, value);
        return message;
    }
...
class SubmitAndWaitResponse$Type extends MessageType<SubmitAndWaitResponse> {
    constructor() {
        super("com.daml.ledger.api.v2.SubmitAndWaitResponse", [
            ...
            { no: 2, name: "completion_offset", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
...
class SubmitAndWaitForTransactionResponse$Type extends MessageType<SubmitAndWaitForTransactionResponse> {
    ...
    create(value?: PartialMessage<SubmitAndWaitForTransactionResponse>): SubmitAndWaitForTransactionResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        if (value !== undefined)
            reflectionMergePartial<SubmitAndWaitForTransactionResponse>(this, message, value);
        return message;
    }
...
class SubmitAndWaitForTransactionTreeResponse$Type extends MessageType<SubmitAndWaitForTransactionTreeResponse> {
    ...
    create(value?: PartialMessage<SubmitAndWaitForTransactionTreeResponse>): SubmitAndWaitForTransactionTreeResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        if (value !== undefined)
            reflectionMergePartial<SubmitAndWaitForTransactionTreeResponse>(this, message, value);
        return message;
    }
...
class SubmitAndWaitForReassignmentRequest$Type extends MessageType<SubmitAndWaitForReassignmentRequest> {
    ...
    create(value?: PartialMessage<SubmitAndWaitForReassignmentRequest>): SubmitAndWaitForReassignmentRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        if (value !== undefined)
            reflectionMergePartial<SubmitAndWaitForReassignmentRequest>(this, message, value);
        return message;
    }
...
class SubmitAndWaitForReassignmentResponse$Type extends MessageType<SubmitAndWaitForReassignmentResponse> {
    ...
    create(value?: PartialMessage<SubmitAndWaitForReassignmentResponse>): SubmitAndWaitForReassignmentResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        if (value !== undefined)
            reflectionMergePartial<SubmitAndWaitForReassignmentResponse>(this, message, value);
        return message;
    }
...
export const CommandService = new ServiceType("com.daml.ledger.api.v2.CommandService", [
    ...
    { name: "SubmitAndWaitForTransactionTree", options: {}, I: SubmitAndWaitRequest, O: SubmitAndWaitForTransactionTreeResponse },
