...
import type { GetUpdateByIdRequest } from "./update_service";
import type { GetUpdateResponse } from "./update_service";
import type { GetUpdateByOffsetRequest } from "./update_service";
import type { GetTransactionResponse } from "./update_service";
import type { GetTransactionByIdRequest } from "./update_service";
import type { GetTransactionTreeResponse } from "./update_service";
import type { GetTransactionByOffsetRequest } from "./update_service";
import type { UnaryCall } from "@protobuf-ts/runtime-rpc";
import type { GetUpdateTreesResponse } from "./update_service";
import { stackIntercept } from "@protobuf-ts/runtime-rpc";
import type { GetUpdatesResponse } from "./update_service";
import type { GetUpdatesRequest } from "./update_service";
...
export class UpdateServiceClient implements IUpdateServiceClient, ServiceInfo {
    ...
    getUpdateTrees(input: GetUpdatesRequest, options?: RpcOptions): ServerStreamingCall<GetUpdatesRequest, GetUpdateTreesResponse> {
        ...
        return stackIntercept<GetUpdatesRequest, GetUpdateTreesResponse>("serverStreaming", this._transport, method, opt, input);
    }
    /**
     * Provided for backwards compatibility, it will be removed in the Canton version 3.4.0.
     * Lookup a transaction tree by its offset.
    ...
    getTransactionTreeByOffset(input: GetTransactionByOffsetRequest, options?: RpcOptions): UnaryCall<GetTransactionByOffsetRequest, GetTransactionTreeResponse> {
        ...
        return stackIntercept<GetTransactionByOffsetRequest, GetTransactionTreeResponse>("unary", this._transport, method, opt, input);
    }
    /**
     * Provided for backwards compatibility, it will be removed in the Canton version 3.4.0.
     * Lookup a transaction tree by its ID.
    ...
    getTransactionTreeById(input: GetTransactionByIdRequest, options?: RpcOptions): UnaryCall<GetTransactionByIdRequest, GetTransactionTreeResponse> {
        ...
        return stackIntercept<GetTransactionByIdRequest, GetTransactionTreeResponse>("unary", this._transport, method, opt, input);
    }
    /**
     * Provided for backwards compatibility, it will be removed in the Canton version 3.4.0.
     * Lookup a transaction by its offset.
    ...
    getTransactionByOffset(input: GetTransactionByOffsetRequest, options?: RpcOptions): UnaryCall<GetTransactionByOffsetRequest, GetTransactionResponse> {
        ...
        return stackIntercept<GetTransactionByOffsetRequest, GetTransactionResponse>("unary", this._transport, method, opt, input);
    }
    /**
     * Provided for backwards compatibility, it will be removed in the Canton version 3.4.0.
     * Lookup a transaction by its ID.
    ...
    getTransactionById(input: GetTransactionByIdRequest, options?: RpcOptions): UnaryCall<GetTransactionByIdRequest, GetTransactionResponse> {
        ...
        return stackIntercept<GetTransactionByIdRequest, GetTransactionResponse>("unary", this._transport, method, opt, input);
    }
    /**
     * Lookup an update by its offset.
     * If there is no update with this offset, or all the events are filtered, an UPDATE_NOT_FOUND error will be raised.
