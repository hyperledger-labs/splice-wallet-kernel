        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* com.daml.ledger.api.v2.UnassignCommand unassign_command */ 1:
                    message.command = {
                        oneofKind: "unassignCommand",
                        unassignCommand: UnassignCommand.internalBinaryRead(reader, reader.uint32(), options, (message.command as any).unassignCommand)
                    };
                    break;
                case /* com.daml.ledger.api.v2.AssignCommand assign_command */ 2:
                    message.command = {
                        oneofKind: "assignCommand",
                        assignCommand: AssignCommand.internalBinaryRead(reader, reader.uint32(), options, (message.command as any).assignCommand)
                    };
                    break;
                default:
                    let u = options.readUnknownField;
