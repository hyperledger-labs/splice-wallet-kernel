...
class ObjectMeta$Type extends MessageType<ObjectMeta> {
    constructor() {
        super("com.daml.ledger.api.v2.admin.ObjectMeta", [
            { no: 6, name: "resource_version", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for com.daml.ledger.api.v2.admin.ObjectMeta.annotations");
            }
        }
        map[key ?? ""] = val ?? "";
    }
