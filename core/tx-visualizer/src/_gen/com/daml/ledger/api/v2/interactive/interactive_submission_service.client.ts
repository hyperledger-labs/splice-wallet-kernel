...
import { InteractiveSubmissionService } from "./interactive_submission_service";
import type { GetPreferredPackageVersionResponse } from "./interactive_submission_service";
import type { GetPreferredPackageVersionRequest } from "./interactive_submission_service";
import type { ExecuteSubmissionResponse } from "./interactive_submission_service";
import type { ExecuteSubmissionRequest } from "./interactive_submission_service";
import { stackIntercept } from "@protobuf-ts/runtime-rpc";
import type { PrepareSubmissionResponse } from "./interactive_submission_service";
import type { PrepareSubmissionRequest } from "./interactive_submission_service";
 ...
 * @generated from protobuf service com.daml.ledger.api.v2.interactive.InteractiveSubmissionService
 */
export class InteractiveSubmissionServiceClient implements IInteractiveSubmissionServiceClient, ServiceInfo {
    ...
    prepareSubmission(input: PrepareSubmissionRequest, options?: RpcOptions): UnaryCall<PrepareSubmissionRequest, PrepareSubmissionResponse> {
        ...
        return stackIntercept<PrepareSubmissionRequest, PrepareSubmissionResponse>("unary", this._transport, method, opt, input);
    }
    /**
     * @generated from protobuf rpc: ExecuteSubmission
     */
    executeSubmission(input: ExecuteSubmissionRequest, options?: RpcOptions): UnaryCall<ExecuteSubmissionRequest, ExecuteSubmissionResponse> {
        ...
        return stackIntercept<ExecuteSubmissionRequest, ExecuteSubmissionResponse>("unary", this._transport, method, opt, input);
    }
    /**
     * A preferred package is the highest-versioned package for a provided package-name
     * that is vetted by all the participants hosting the provided parties.
    ...
    getPreferredPackageVersion(input: GetPreferredPackageVersionRequest, options?: RpcOptions): UnaryCall<GetPreferredPackageVersionRequest, GetPreferredPackageVersionResponse> {
        ...
        return stackIntercept<GetPreferredPackageVersionRequest, GetPreferredPackageVersionResponse>("unary", this._transport, method, opt, input);
    }
}
