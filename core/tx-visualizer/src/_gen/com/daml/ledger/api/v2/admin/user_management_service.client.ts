...
import type { UpdateUserIdentityProviderIdResponse } from "./user_management_service";
import type { UpdateUserIdentityProviderIdRequest } from "./user_management_service";
import type { ListUserRightsResponse } from "./user_management_service";
import type { ListUserRightsRequest } from "./user_management_service";
import type { RevokeUserRightsResponse } from "./user_management_service";
import type { RevokeUserRightsRequest } from "./user_management_service";
import type { GrantUserRightsResponse } from "./user_management_service";
import type { GrantUserRightsRequest } from "./user_management_service";
import type { ListUsersResponse } from "./user_management_service";
import type { ListUsersRequest } from "./user_management_service";
import type { DeleteUserResponse } from "./user_management_service";
import type { DeleteUserRequest } from "./user_management_service";
import type { UpdateUserResponse } from "./user_management_service";
import type { UpdateUserRequest } from "./user_management_service";
import type { GetUserResponse } from "./user_management_service";
import type { GetUserRequest } from "./user_management_service";
import { stackIntercept } from "@protobuf-ts/runtime-rpc";
import type { CreateUserResponse } from "./user_management_service";
import type { CreateUserRequest } from "./user_management_service";
 ...
 * @generated from protobuf service com.daml.ledger.api.v2.admin.UserManagementService
 */
export class UserManagementServiceClient implements IUserManagementServiceClient, ServiceInfo {
    ...
    grantUserRights(input: GrantUserRightsRequest, options?: RpcOptions): UnaryCall<GrantUserRightsRequest, GrantUserRightsResponse> {
        ...
        return stackIntercept<GrantUserRightsRequest, GrantUserRightsResponse>("unary", this._transport, method, opt, input);
    }
    /**
     * Revoke rights from a user.
     * Revoking rights does not affect the resource version of the corresponding user.
    ...
    revokeUserRights(input: RevokeUserRightsRequest, options?: RpcOptions): UnaryCall<RevokeUserRightsRequest, RevokeUserRightsResponse> {
        ...
        return stackIntercept<RevokeUserRightsRequest, RevokeUserRightsResponse>("unary", this._transport, method, opt, input);
    }
    /**
     * List the set of all rights granted to a user.
     *
    ...
    listUserRights(input: ListUserRightsRequest, options?: RpcOptions): UnaryCall<ListUserRightsRequest, ListUserRightsResponse> {
        ...
        return stackIntercept<ListUserRightsRequest, ListUserRightsResponse>("unary", this._transport, method, opt, input);
    }
    /**
     * Update the assignment of a user from one IDP to another.
     *
    ...
    updateUserIdentityProviderId(input: UpdateUserIdentityProviderIdRequest, options?: RpcOptions): UnaryCall<UpdateUserIdentityProviderIdRequest, UpdateUserIdentityProviderIdResponse> {
        ...
        return stackIntercept<UpdateUserIdentityProviderIdRequest, UpdateUserIdentityProviderIdResponse>("unary", this._transport, method, opt, input);
    }
}
