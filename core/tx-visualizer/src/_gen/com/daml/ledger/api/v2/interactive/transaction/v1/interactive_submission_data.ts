...
class Fetch$Type extends MessageType<Fetch> {
    ...
    internalBinaryWrite(message: Fetch, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.interfaceId)
            Identifier.internalBinaryWrite(message.interfaceId, writer.tag(8, WireType.LengthDelimited).fork(), options).join();
...
class Exercise$Type extends MessageType<Exercise> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Exercise): Exercise {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: Exercise, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string lf_version = 1; */
        if (message.lfVersion !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.lfVersion);
        /* string contract_id = 2; */
        ...
        if (message.exerciseResult)
            Value.internalBinaryWrite(message.exerciseResult, writer.tag(13, WireType.LengthDelimited).fork(), options).join();
...
class Create$Type extends MessageType<Create> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Create): Create {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: Create, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string lf_version = 1; */
        if (message.lfVersion !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.lfVersion);
        /* string contract_id = 2; */
...
class Rollback$Type extends MessageType<Rollback> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Rollback): Rollback {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: Rollback, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class Node$Type extends MessageType<Node> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* com.daml.ledger.api.v2.interactive.transaction.v1.Create create */ 1:
                    message.nodeType = {
                        oneofKind: "create",
                        create: Create.internalBinaryRead(reader, reader.uint32(), options, (message.nodeType as any).create)
                    };
                    break;
                case /* com.daml.ledger.api.v2.interactive.transaction.v1.Fetch fetch */ 2:
                    message.nodeType = {
                        oneofKind: "fetch",
                        fetch: Fetch.internalBinaryRead(reader, reader.uint32(), options, (message.nodeType as any).fetch)
                    };
                    break;
                case /* com.daml.ledger.api.v2.interactive.transaction.v1.Exercise exercise */ 3:
                    message.nodeType = {
                        oneofKind: "exercise",
                        exercise: Exercise.internalBinaryRead(reader, reader.uint32(), options, (message.nodeType as any).exercise)
                    };
                    break;
                case /* com.daml.ledger.api.v2.interactive.transaction.v1.Rollback rollback */ 4:
                    message.nodeType = {
                        oneofKind: "rollback",
                        rollback: Rollback.internalBinaryRead(reader, reader.uint32(), options, (message.nodeType as any).rollback)
                    };
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: Node, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.nodeType.oneofKind === "create")
            Create.internalBinaryWrite(message.nodeType.create, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        ...
        if (message.nodeType.oneofKind === "exercise")
            Exercise.internalBinaryWrite(message.nodeType.exercise, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* com.daml.ledger.api.v2.interactive.transaction.v1.Rollback rollback = 4; */
        if (message.nodeType.oneofKind === "rollback")
            Rollback.internalBinaryWrite(message.nodeType.rollback, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
