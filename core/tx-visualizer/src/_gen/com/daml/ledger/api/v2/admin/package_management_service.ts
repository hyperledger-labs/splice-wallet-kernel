...
class ListKnownPackagesRequest$Type extends MessageType<ListKnownPackagesRequest> {
    ...
    create(value?: PartialMessage<ListKnownPackagesRequest>): ListKnownPackagesRequest {
        ...
        if (value !== undefined)
            reflectionMergePartial<ListKnownPackagesRequest>(this, message, value);
        return message;
    }
...
class ListKnownPackagesResponse$Type extends MessageType<ListKnownPackagesResponse> {
    ...
    create(value?: PartialMessage<ListKnownPackagesResponse>): ListKnownPackagesResponse {
        ...
        if (value !== undefined)
            reflectionMergePartial<ListKnownPackagesResponse>(this, message, value);
        return message;
    }
...
class PackageDetails$Type extends MessageType<PackageDetails> {
    constructor() {
        super("com.daml.ledger.api.v2.admin.PackageDetails", [
            ...
            { no: 2, name: "package_size", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
...
class ValidateDarFileResponse$Type extends MessageType<ValidateDarFileResponse> {
    ...
    create(value?: PartialMessage<ValidateDarFileResponse>): ValidateDarFileResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        if (value !== undefined)
            reflectionMergePartial<ValidateDarFileResponse>(this, message, value);
        return message;
    }
