...
import { ExercisedEvent } from "./event";
...
class TreeEvent$Type extends MessageType<TreeEvent> {
    constructor() {
        super("com.daml.ledger.api.v2.TreeEvent", [
            { no: 1, name: "created", kind: "message", oneof: "kind", T: () => CreatedEvent },
            { no: 2, name: "exercised", kind: "message", oneof: "kind", T: () => ExercisedEvent }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* com.daml.ledger.api.v2.CreatedEvent created */ 1:
                    message.kind = {
                        oneofKind: "created",
                        created: CreatedEvent.internalBinaryRead(reader, reader.uint32(), options, (message.kind as any).created)
                    };
                    break;
                case /* com.daml.ledger.api.v2.ExercisedEvent exercised */ 2:
                    message.kind = {
                        oneofKind: "exercised",
                        exercised: ExercisedEvent.internalBinaryRead(reader, reader.uint32(), options, (message.kind as any).exercised)
                    };
                    break;
                default:
...
class TransactionTree$Type extends MessageType<TransactionTree> {
    constructor() {
        super("com.daml.ledger.api.v2.TransactionTree", [
            ...
            { no: 6, name: "events_by_id", kind: "map", K: 5 /*ScalarType.INT32*/, V: { kind: "message", T: () => TreeEvent } },
    ...
    private binaryReadMap6(map: TransactionTree["eventsById"], reader: IBinaryReader, options: BinaryReadOptions): void {
        let len = reader.uint32(), end = reader.pos + len, key: keyof TransactionTree["eventsById"] | undefined, val: TransactionTree["eventsById"][any] | undefined;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case 1:
                ...
                case 2:
                    ...
                    break;
                default: throw new globalThis.Error("unknown map entry field for com.daml.ledger.api.v2.TransactionTree.events_by_id");
            }
        }
    ...
    internalBinaryWrite(message: TransactionTree, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let k of globalThis.Object.keys(message.eventsById)) {
            ...
            TreeEvent.internalBinaryWrite(message.eventsById[k as any], writer, options);
            writer.join().join();
        }
        /* string synchronizer_id = 7; */
        if (message.synchronizerId !== "")
            writer.tag(7, WireType.LengthDelimited).string(message.synchronizerId);
