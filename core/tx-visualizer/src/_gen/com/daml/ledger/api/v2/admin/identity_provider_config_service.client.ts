...
import { IdentityProviderConfigService } from "./identity_provider_config_service";
import type { DeleteIdentityProviderConfigResponse } from "./identity_provider_config_service";
import type { DeleteIdentityProviderConfigRequest } from "./identity_provider_config_service";
import type { ListIdentityProviderConfigsResponse } from "./identity_provider_config_service";
import type { ListIdentityProviderConfigsRequest } from "./identity_provider_config_service";
import type { UpdateIdentityProviderConfigResponse } from "./identity_provider_config_service";
import type { UpdateIdentityProviderConfigRequest } from "./identity_provider_config_service";
import type { GetIdentityProviderConfigResponse } from "./identity_provider_config_service";
import type { GetIdentityProviderConfigRequest } from "./identity_provider_config_service";
import { stackIntercept } from "@protobuf-ts/runtime-rpc";
import type { CreateIdentityProviderConfigResponse } from "./identity_provider_config_service";
import type { CreateIdentityProviderConfigRequest } from "./identity_provider_config_service";
 ...
 * @generated from protobuf service com.daml.ledger.api.v2.admin.IdentityProviderConfigService
 */
export class IdentityProviderConfigServiceClient implements IIdentityProviderConfigServiceClient, ServiceInfo {
    ...
    createIdentityProviderConfig(input: CreateIdentityProviderConfigRequest, options?: RpcOptions): UnaryCall<CreateIdentityProviderConfigRequest, CreateIdentityProviderConfigResponse> {
        ...
        return stackIntercept<CreateIdentityProviderConfigRequest, CreateIdentityProviderConfigResponse>("unary", this._transport, method, opt, input);
    }
    /**
     * Get the identity provider configuration data by id.
     *
    ...
    getIdentityProviderConfig(input: GetIdentityProviderConfigRequest, options?: RpcOptions): UnaryCall<GetIdentityProviderConfigRequest, GetIdentityProviderConfigResponse> {
        ...
        return stackIntercept<GetIdentityProviderConfigRequest, GetIdentityProviderConfigResponse>("unary", this._transport, method, opt, input);
    }
    /**
     * Update selected modifiable attribute of an identity provider config resource described
     * by the ``IdentityProviderConfig`` message.
    ...
    updateIdentityProviderConfig(input: UpdateIdentityProviderConfigRequest, options?: RpcOptions): UnaryCall<UpdateIdentityProviderConfigRequest, UpdateIdentityProviderConfigResponse> {
        ...
        return stackIntercept<UpdateIdentityProviderConfigRequest, UpdateIdentityProviderConfigResponse>("unary", this._transport, method, opt, input);
    }
    /**
     * List all existing identity provider configurations.
     *
    ...
    listIdentityProviderConfigs(input: ListIdentityProviderConfigsRequest, options?: RpcOptions): UnaryCall<ListIdentityProviderConfigsRequest, ListIdentityProviderConfigsResponse> {
        ...
        return stackIntercept<ListIdentityProviderConfigsRequest, ListIdentityProviderConfigsResponse>("unary", this._transport, method, opt, input);
    }
    /**
     * Delete an existing identity provider configuration.
     *
    ...
    deleteIdentityProviderConfig(input: DeleteIdentityProviderConfigRequest, options?: RpcOptions): UnaryCall<DeleteIdentityProviderConfigRequest, DeleteIdentityProviderConfigResponse> {
        ...
        return stackIntercept<DeleteIdentityProviderConfigRequest, DeleteIdentityProviderConfigResponse>("unary", this._transport, method, opt, input);
    }
}
