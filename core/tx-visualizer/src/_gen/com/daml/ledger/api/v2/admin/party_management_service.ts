...
class GetParticipantIdRequest$Type extends MessageType<GetParticipantIdRequest> {
    ...
    create(value?: PartialMessage<GetParticipantIdRequest>): GetParticipantIdRequest {
        ...
        if (value !== undefined)
            reflectionMergePartial<GetParticipantIdRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetParticipantIdRequest): GetParticipantIdRequest {
    ...
    internalBinaryWrite(message: GetParticipantIdRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class GetParticipantIdResponse$Type extends MessageType<GetParticipantIdResponse> {
    ...
    create(value?: PartialMessage<GetParticipantIdResponse>): GetParticipantIdResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.participantId = "";
        if (value !== undefined)
            reflectionMergePartial<GetParticipantIdResponse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetParticipantIdResponse): GetParticipantIdResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetParticipantIdResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class GetPartiesRequest$Type extends MessageType<GetPartiesRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetPartiesRequest): GetPartiesRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetPartiesRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class GetPartiesResponse$Type extends MessageType<GetPartiesResponse> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetPartiesResponse): GetPartiesResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetPartiesResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class ListKnownPartiesRequest$Type extends MessageType<ListKnownPartiesRequest> {
    ...
    create(value?: PartialMessage<ListKnownPartiesRequest>): ListKnownPartiesRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.pageToken = "";
        message.pageSize = 0;
        message.identityProviderId = "";
        if (value !== undefined)
            reflectionMergePartial<ListKnownPartiesRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ListKnownPartiesRequest): ListKnownPartiesRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: ListKnownPartiesRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string identity_provider_id = 1; */
        if (message.identityProviderId !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.identityProviderId);
        /* string page_token = 2; */
...
class ListKnownPartiesResponse$Type extends MessageType<ListKnownPartiesResponse> {
    ...
    create(value?: PartialMessage<ListKnownPartiesResponse>): ListKnownPartiesResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.partyDetails = [];
        message.nextPageToken = "";
        if (value !== undefined)
            reflectionMergePartial<ListKnownPartiesResponse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ListKnownPartiesResponse): ListKnownPartiesResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: ListKnownPartiesResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated com.daml.ledger.api.v2.admin.PartyDetails party_details = 1; */
        for (let i = 0; i < message.partyDetails.length; i++)
            PartyDetails.internalBinaryWrite(message.partyDetails[i], writer.tag(1, WireType.LengthDelimited).fork(), options).join();
...
class AllocatePartyRequest$Type extends MessageType<AllocatePartyRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: AllocatePartyRequest): AllocatePartyRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: AllocatePartyRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.synchronizerId !== "")
            writer.tag(5, WireType.LengthDelimited).string(message.synchronizerId);
        /* string user_id = 6; */
        if (message.userId !== "")
...
class AllocatePartyResponse$Type extends MessageType<AllocatePartyResponse> {
    ...
    create(value?: PartialMessage<AllocatePartyResponse>): AllocatePartyResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        if (value !== undefined)
            reflectionMergePartial<AllocatePartyResponse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: AllocatePartyResponse): AllocatePartyResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: AllocatePartyResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class UpdatePartyDetailsRequest$Type extends MessageType<UpdatePartyDetailsRequest> {
    ...
    create(value?: PartialMessage<UpdatePartyDetailsRequest>): UpdatePartyDetailsRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        if (value !== undefined)
            reflectionMergePartial<UpdatePartyDetailsRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: UpdatePartyDetailsRequest): UpdatePartyDetailsRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: UpdatePartyDetailsRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* com.daml.ledger.api.v2.admin.PartyDetails party_details = 1; */
        if (message.partyDetails)
            PartyDetails.internalBinaryWrite(message.partyDetails, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
...
class UpdatePartyDetailsResponse$Type extends MessageType<UpdatePartyDetailsResponse> {
    ...
    create(value?: PartialMessage<UpdatePartyDetailsResponse>): UpdatePartyDetailsResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        if (value !== undefined)
            reflectionMergePartial<UpdatePartyDetailsResponse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: UpdatePartyDetailsResponse): UpdatePartyDetailsResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: UpdatePartyDetailsResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* com.daml.ledger.api.v2.admin.PartyDetails party_details = 1; */
        if (message.partyDetails)
            PartyDetails.internalBinaryWrite(message.partyDetails, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
...
class PartyDetails$Type extends MessageType<PartyDetails> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: PartyDetails): PartyDetails {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: PartyDetails, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string party = 1; */
        if (message.party !== "")
...
class UpdatePartyIdentityProviderIdRequest$Type extends MessageType<UpdatePartyIdentityProviderIdRequest> {
    ...
    create(value?: PartialMessage<UpdatePartyIdentityProviderIdRequest>): UpdatePartyIdentityProviderIdRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.party = "";
        message.sourceIdentityProviderId = "";
        message.targetIdentityProviderId = "";
        if (value !== undefined)
            reflectionMergePartial<UpdatePartyIdentityProviderIdRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: UpdatePartyIdentityProviderIdRequest): UpdatePartyIdentityProviderIdRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: UpdatePartyIdentityProviderIdRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string party = 1; */
        if (message.party !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.party);
...
class UpdatePartyIdentityProviderIdResponse$Type extends MessageType<UpdatePartyIdentityProviderIdResponse> {
    ...
    create(value?: PartialMessage<UpdatePartyIdentityProviderIdResponse>): UpdatePartyIdentityProviderIdResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        if (value !== undefined)
            reflectionMergePartial<UpdatePartyIdentityProviderIdResponse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: UpdatePartyIdentityProviderIdResponse): UpdatePartyIdentityProviderIdResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: UpdatePartyIdentityProviderIdResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
