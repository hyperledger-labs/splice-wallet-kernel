            ...
            switch (fieldNo) {
                case /* com.daml.ledger.api.v2.WildcardFilter wildcard_filter */ 1:
                    message.identifierFilter = {
                        oneofKind: "wildcardFilter",
                        wildcardFilter: WildcardFilter.internalBinaryRead(reader, reader.uint32(), options, (message.identifierFilter as any).wildcardFilter)
                    };
                    break;
                case /* com.daml.ledger.api.v2.InterfaceFilter interface_filter */ 2:
                    message.identifierFilter = {
                        oneofKind: "interfaceFilter",
                        interfaceFilter: InterfaceFilter.internalBinaryRead(reader, reader.uint32(), options, (message.identifierFilter as any).interfaceFilter)
                    };
                    break;
                case /* com.daml.ledger.api.v2.TemplateFilter template_filter */ 3:
                    message.identifierFilter = {
                        oneofKind: "templateFilter",
                        templateFilter: TemplateFilter.internalBinaryRead(reader, reader.uint32(), options, (message.identifierFilter as any).templateFilter)
                    };
                    break;
                default:
                    let u = options.readUnknownField;
...
class TransactionFilter$Type extends MessageType<TransactionFilter> {
    ...
    private binaryReadMap1(map: TransactionFilter["filtersByParty"], reader: IBinaryReader, options: BinaryReadOptions): void {
        let len = reader.uint32(), end = reader.pos + len, key: keyof TransactionFilter["filtersByParty"] | undefined, val: TransactionFilter["filtersByParty"][any] | undefined;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case 1:
                ...
                case 2:
                    ...
                    break;
                default: throw new globalThis.Error("unknown map entry field for com.daml.ledger.api.v2.TransactionFilter.filters_by_party");
            }
        }
...
class EventFormat$Type extends MessageType<EventFormat> {
    ...
    private binaryReadMap1(map: EventFormat["filtersByParty"], reader: IBinaryReader, options: BinaryReadOptions): void {
        let len = reader.uint32(), end = reader.pos + len, key: keyof EventFormat["filtersByParty"] | undefined, val: EventFormat["filtersByParty"][any] | undefined;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case 1:
                ...
                case 2:
                    val = Filters.internalBinaryRead(reader, reader.uint32(), options);
                    break;
                default: throw new globalThis.Error("unknown map entry field for com.daml.ledger.api.v2.EventFormat.filters_by_party");
            }
        }
        map[key ?? ""] = val ?? Filters.create();
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* com.daml.ledger.api.v2.ParticipantAuthorizationTopologyFormat include_participant_authorization_events */ 1:
                    message.includeParticipantAuthorizationEvents = ParticipantAuthorizationTopologyFormat.internalBinaryRead(reader, reader.uint32(), options, message.includeParticipantAuthorizationEvents);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
...
class ParticipantAuthorizationTopologyFormat$Type extends MessageType<ParticipantAuthorizationTopologyFormat> {
    ...
    create(value?: PartialMessage<ParticipantAuthorizationTopologyFormat>): ParticipantAuthorizationTopologyFormat {
        ...
        message.parties = [];
        if (value !== undefined)
            reflectionMergePartial<ParticipantAuthorizationTopologyFormat>(this, message, value);
        return message;
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* com.daml.ledger.api.v2.TransactionFormat include_transactions */ 1:
                    message.includeTransactions = TransactionFormat.internalBinaryRead(reader, reader.uint32(), options, message.includeTransactions);
                    break;
                case /* com.daml.ledger.api.v2.EventFormat include_reassignments */ 2:
                    message.includeReassignments = EventFormat.internalBinaryRead(reader, reader.uint32(), options, message.includeReassignments);
                    break;
                case /* com.daml.ledger.api.v2.TopologyFormat include_topology_events */ 3:
                    message.includeTopologyEvents = TopologyFormat.internalBinaryRead(reader, reader.uint32(), options, message.includeTopologyEvents);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
