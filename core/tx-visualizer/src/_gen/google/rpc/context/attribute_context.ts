...
class AttributeContext$Type extends MessageType<AttributeContext> {
    constructor() {
        super("google.rpc.context.AttributeContext", [
            ...
            { no: 8, name: "extensions", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Any }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for google.rpc.context.AttributeContext.Resource.annotations");
            }
        }
        map[key ?? ""] = val ?? "";
    }
